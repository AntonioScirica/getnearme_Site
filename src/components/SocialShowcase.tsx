...
function Img({ src }: { src: string }) {
  ...
  return <img src={src} alt="" loading="eager" decoding="async" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover' }} />;
}
...
function TplGradient({ photo, bd = 0 }: { photo: string; bd?: number }) {
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%', fontFamily: F, overflow: 'hidden' }}>
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img src={photo} alt="" loading="eager" decoding="async" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', animation: 'tplKB 10s ease-in-out infinite alternate' }} />
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%', fontFamily: F, background: '#fff', overflow: 'hidden', border: '1px solid #d1d5db', borderRadius: 8, boxSizing: 'border-box' }}>
      ...
      <div style={{
        ...
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src={photo} alt="" loading="eager" decoding="async" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block', transformOrigin: 'center bottom', animation: 'tplKB 10s ease-in-out infinite alternate' }} />
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%', display: 'flex', fontFamily: F, overflow: 'hidden' }}>
      ...
      <div style={{ width: '50%', position: 'relative', overflow: 'hidden' }}>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src={photo} alt="" loading="eager" decoding="async" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block', animation: 'tplKB 10s ease-in-out infinite alternate' }} />
