    ...
    <RevealSection delay={index * 50}>
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span style={{ color: '#1a1a2e', fontWeight: 800, fontSize: 14 }}>{question}</span>
          <span
            style={{
              width: 31,
              height: 31,
        ...
        <div style={{ maxHeight: open ? 180 : 0, overflow: 'hidden', transition: 'max-height 0.4s ease' }}>
          <p style={{ color: '#444', fontSize: 13, lineHeight: 1.7, margin: '13px 0 0' }}>{answer}</p>
        </div>
      </div>
    </RevealSection>
  );
