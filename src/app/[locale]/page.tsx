...
export default async function Home({ params }: Props) {
  ...
  const cardImages = [
    ...
    "/assets/png/prezzi.png",
    "/assets/png/report.png",
  ];
      ...
      <main className="pt-32 pb-0 relative bg-white">
        ...
        <section className="relative px-6 max-w-7xl mx-auto text-center mb-32 z-10">
          ...
          <div className="relative z-10 max-w-4xl mx-auto space-y-4 pt-16 pb-10">
            <h1
              className="text-4xl md:text-6xl font-bold text-slate-900 leading-[1.05] tracking-tight"
              style={{
        ...
        <section id="funzionalita" className="px-6 max-w-7xl mx-auto py-24">
          <div className="flex flex-col md:flex-row justify-between items-center mb-16 gap-8">
            <h2
              className="text-4xl md:text-5xl font-bold text-slate-900 max-w-md leading-tight text-center md:text-left"
              style={{
                fontFamily: 'var(--font-old-standard), "Old Standard TT", serif',
              }}
            >
        ...
        <section id="prezzi" className="px-6 max-w-7xl mx-auto py-24">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-3 mb-12">
            {t.pricing.plans.map(
              (plan: { name: string; subtitle?: string; desc: string }, i: number) => {
                const isPopular = i === 2;
                const isFree = i === 0;
                const price =
                  i === 1 ? "4,99" : i === 2 ? "9,99" : i === 3 ? "24,99" : t.pricing.free;
                const buttonText = isFree ? t.pricing.registerNow : t.pricing.buyNow;

                return (
                  <article
                    key={i}
                    className={`relative bg-white rounded-2xl border-2 p-6 hover:shadow-xl transition-all flex flex-col ${
        ...
        <section id="estensione" className="px-6 max-w-7xl mx-auto py-32">
          <div className="max-w-4xl mx-auto text-center space-y-4">
            <h2
              className="text-4xl md:text-5xl font-bold text-slate-900 leading-tight mb-2"
              style={{
                fontFamily: 'var(--font-old-standard), "Old Standard TT", serif',
              }}
            >
