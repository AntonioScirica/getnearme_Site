  ...
  it: {
    ...
    landing: {
      ...
      features: {
        ...
        items: [
          { num: "01", title: "Il quartiere raccontato bene", desc: "Scuole, trasporti, supermercati, parchi, sanità, ristoranti a portata di click. Mostra al cliente cosa vuol dire davvero vivere lì.", icon: "🗺️", color: "#0ea5e9" },
          { num: "02", title: "Valore al m² sempre sotto mano", desc: "Valori di mercato aggiornati per la zona e confronti tra immobili, per parlare di prezzo con sicurezza davanti al cliente.", icon: "📊", color: "#f59e0b" },
          { num: "03", title: "Homestaging AI in 10 secondi", desc: "Stanze vuote → ambienti arredati in 8 stili. Il before/after che convince il proprietario a firmare con te.", icon: "✨", color: "#6366f1" },
          { num: "04", title: "Presentazioni video per il cliente", desc: "6 template: avatar parlante, sottotitoli, walkthrough, before/after. Racconta l'immobile in modo professionale, senza editing.", icon: "🎬", color: "#10b981" },
          { num: "05", title: "Contenuti pronti per ogni canale", desc: "22 layout ottimizzati per i canali dove i tuoi clienti ti trovano. Il tuo logo, i tuoi colori, la tua identità.", icon: "📱", color: "#ec4899" },
          { num: "06", title: "Report white-label e team", desc: "Presentazioni professionali col tuo brand, condivise con l'intera agenzia (fino a 5 agenti). Un'immagine coerente verso ogni cliente.", icon: "📄", color: "#f97316" },
        ],
      },
      testimonials: {
      ...
      howItWorks: {
        ...
        steps: [
          { step: "1", title: "Aggiungi a Chrome", desc: "Un click dallo Store. L'estensione si installa nel browser in pochi secondi.", color: "#6366f1", bg: "#eef2ff", emoji: "🧩" },
          { step: "2", title: "Apri un annuncio", desc: "immobiliare.it, idealista.it o casa.it — i portali dove già lavori ogni giorno.", color: "#f59e0b", bg: "#fffbeb", emoji: "🔍" },
          { step: "3", title: "Presenta al cliente", desc: "Foto valorizzate, video, contesto del quartiere e report pronti. Tutto quello che ti serve per fare bella figura.", color: "#10b981", bg: "#ecfdf5", emoji: "✨" },
        ],
      },
      faq: {
        title: "Domande?",
      ...
      popups: [
        ...
        { icon: "🎬", text: "Un agente ha appena generato un video promozionale", time: "" },
        ...
        { icon: "✨", text: "Marco da Milano ha arredato 14 stanze con l'AI oggi", time: "5 min fa" },
        { icon: "⭐", text: "Agenzia Immobiliare Rossi ha fatto upgrade al piano Annuale", time: "18 min fa" },
        { icon: "📱", text: "127 post social creati questa settimana", time: "" },
        { icon: "🎯", text: "Giulia da Roma ha esportato 8 PDF white-label", time: "7 min fa" },
        { icon: "💼", text: "Un'agenzia di Torino si è appena registrata", time: "2 min fa" },
        { icon: "🏆", text: "GetNearMe usato da oltre 200 agenti in Italia", time: "" },
        { icon: "🗺️", text: "Andrea da Bologna ha generato 5 analisi di quartiere oggi", time: "9 min fa" },
      ],
    },
  },
  en: {
    ...
    landing: {
      ...
      features: {
        ...
        items: [
          { num: "01", title: "Compare and close faster", desc: "Visual side-by-side property comparison. Structured data = faster decisions.", icon: "⚡", color: "#f59e0b" },
          { num: "02", title: "AI Homestaging in 10s", desc: "Empty rooms → furnished spaces. Before/after that sell before the visit.", icon: "✨", color: "#6366f1" },
          { num: "03", title: "Ready-made social posts", desc: "From listing to Instagram/Facebook post automatically. Zero manual design.", icon: "📱", color: "#ec4899" },
          { num: "04", title: "Videos without a videographer", desc: "Promotional videos for every property in a few clicks. Content that captures.", icon: "🎬", color: "#10b981" },
          { num: "05", title: "Live price per m²", desc: "Concrete data for valuations, acquisitions and negotiations. No more guesswork.", icon: "📊", color: "#f97316" },
          { num: "06", title: "Smart neighborhood map", desc: "Services, transport, schools, green areas analyzed by distance and relevance.", icon: "🗺️", color: "#0ea5e9" },
        ],
      },
      testimonials: {
      ...
      howItWorks: {
        ...
        steps: [
          { step: "1", title: "Choose your plan", desc: "Starter, Agency or Pro — the one that fits you.", color: "#f59e0b", bg: "#fffbeb", emoji: "🎯" },
          { step: "2", title: "Install the extension", desc: "One click on Chrome Web Store. 5 seconds.", color: "#6366f1", bg: "#eef2ff", emoji: "🧩" },
          { step: "3", title: "Browse and analyze", desc: "Open a property portal and GetNearMe works.", color: "#10b981", bg: "#ecfdf5", emoji: "✨" },
        ],
      },
      faq: {
        title: "Questions?",
      ...
      popups: [
        ...
        { icon: "🏠", text: "Marco from Milan generated 14 reports today", time: "5 min ago" },
        { icon: "⭐", text: "Rossi Real Estate upgraded to the Pro plan", time: "18 min ago" },
        { icon: "📈", text: "342 property analyses completed today", time: "" },
        { icon: "🎯", text: "Giulia from Rome exported 8 PDFs this week", time: "7 min ago" },
        { icon: "💼", text: "An agency from Turin just signed up", time: "2 min ago" },
        { icon: "🏆", text: "GetNearMe is used by 200+ agencies in Italy", time: "" },
        { icon: "📱", text: "Andrea from Bologna created 5 social posts today", time: "9 min ago" },
  ...
  es: {
    ...
    landing: {
      ...
      features: {
        ...
        items: [
          { num: "01", title: "Compara y cierra antes", desc: "Comparación visual lado a lado entre inmuebles. Datos estructurados = decisiones más rápidas.", icon: "⚡", color: "#f59e0b" },
          { num: "02", title: "Homestaging IA en 10s", desc: "Habitaciones vacías → ambientes amueblados. Antes/después que venden antes de la visita.", icon: "✨", color: "#6366f1" },
          { num: "03", title: "Posts sociales ya listos", desc: "Del anuncio al post de Instagram/Facebook automáticamente. Cero diseño manual.", icon: "📱", color: "#ec4899" },
          { num: "04", title: "Vídeos sin videógrafo", desc: "Vídeos promocionales para cada inmueble en pocos clics. Contenido que cautiva.", icon: "🎬", color: "#10b981" },
          { num: "05", title: "Precio por m² en vivo", desc: "Datos concretos para valoraciones, adquisiciones y negociaciones. Sin más estimaciones a ojo.", icon: "📊", color: "#f97316" },
          { num: "06", title: "Mapa de barrio inteligente", desc: "Servicios, transporte, colegios, zonas verdes analizados por distancia y relevancia.", icon: "🗺️", color: "#0ea5e9" },
        ],
      },
      testimonials: {
      ...
      howItWorks: {
        ...
        steps: [
          { step: "1", title: "Elige tu plan", desc: "Starter, Agency o Pro — el que mejor se adapte.", color: "#f59e0b", bg: "#fffbeb", emoji: "🎯" },
          { step: "2", title: "Instala la extensión", desc: "Un clic en Chrome Web Store. 5 segundos.", color: "#6366f1", bg: "#eef2ff", emoji: "🧩" },
          { step: "3", title: "Navega y analiza", desc: "Abre un portal inmobiliario y GetNearMe trabaja.", color: "#10b981", bg: "#ecfdf5", emoji: "✨" },
        ],
      },
      faq: {
        title: "¿Preguntas?",
      ...
      popups: [
        ...
        { icon: "🏠", text: "Marco de Milán generó 14 informes hoy", time: "hace 5 min" },
        { icon: "⭐", text: "Inmobiliaria Rossi pasó al plan Pro", time: "hace 18 min" },
        { icon: "📈", text: "342 análisis inmobiliarios completados hoy", time: "" },
        { icon: "🎯", text: "Giulia de Roma exportó 8 PDFs esta semana", time: "hace 7 min" },
        { icon: "💼", text: "Una agencia de Turín acaba de registrarse", time: "hace 2 min" },
        { icon: "🏆", text: "GetNearMe es usado por más de 200 agencias en Italia", time: "" },
        { icon: "📱", text: "Andrea de Bolonia creó 5 posts sociales hoy", time: "hace 9 min" },
  ...
  fr: {
    ...
    landing: {
      ...
      features: {
        ...
        items: [
          { num: "01", title: "Comparez et concluez plus vite", desc: "Comparaison visuelle côte à côte des biens. Données structurées = décisions plus rapides.", icon: "⚡", color: "#f59e0b" },
          { num: "02", title: "Homestaging IA en 10s", desc: "Pièces vides → espaces meublés. Avant/après qui vendent avant la visite.", icon: "✨", color: "#6366f1" },
          { num: "03", title: "Posts sociaux déjà prêts", desc: "De l'annonce au post Instagram/Facebook automatiquement. Zéro design manuel.", icon: "📱", color: "#ec4899" },
          { num: "04", title: "Vidéos sans vidéaste", desc: "Vidéos promotionnelles pour chaque bien en quelques clics. Du contenu qui captive.", icon: "🎬", color: "#10b981" },
          { num: "05", title: "Prix au m² en direct", desc: "Données concrètes pour évaluations, acquisitions et négociations. Fini les estimations au doigt mouillé.", icon: "📊", color: "#f97316" },
          { num: "06", title: "Carte de quartier intelligente", desc: "Services, transports, écoles, espaces verts analysés par distance et pertinence.", icon: "🗺️", color: "#0ea5e9" },
        ],
      },
      testimonials: {
      ...
      howItWorks: {
        ...
        steps: [
          { step: "1", title: "Choisissez votre plan", desc: "Starter, Agency ou Pro — celui qui vous convient.", color: "#f59e0b", bg: "#fffbeb", emoji: "🎯" },
          { step: "2", title: "Installez l'extension", desc: "Un clic sur Chrome Web Store. 5 secondes.", color: "#6366f1", bg: "#eef2ff", emoji: "🧩" },
          { step: "3", title: "Naviguez et analysez", desc: "Ouvrez un portail immobilier et GetNearMe travaille.", color: "#10b981", bg: "#ecfdf5", emoji: "✨" },
        ],
      },
      faq: {
        title: "Questions ?",
      ...
      popups: [
        ...
        { icon: "🏠", text: "Marco de Milan a généré 14 rapports aujourd'hui", time: "il y a 5 min" },
        { icon: "⭐", text: "Agence Immobilière Rossi est passée au plan Pro", time: "il y a 18 min" },
        { icon: "📈", text: "342 analyses immobilières complétées aujourd'hui", time: "" },
        { icon: "🎯", text: "Giulia de Rome a exporté 8 PDFs cette semaine", time: "il y a 7 min" },
        { icon: "💼", text: "Une agence de Turin vient de s'inscrire", time: "il y a 2 min" },
        { icon: "🏆", text: "GetNearMe est utilisé par plus de 200 agences en Italie", time: "" },
        { icon: "📱", text: "Andrea de Bologne a créé 5 posts sociaux aujourd'hui", time: "il y a 9 min" },
  ...
  ru: {
    ...
    landing: {
      ...
      features: {
        ...
        items: [
          { num: "01", title: "Сравнивайте и закрывайте быстрее", desc: "Визуальное сравнение объектов бок о бок. Структурированные данные = быстрые решения.", icon: "⚡", color: "#f59e0b" },
          { num: "02", title: "ИИ-хоумстейджинг за 10с", desc: "Пустые комнаты → обставленные интерьеры. До/после, которые продают ещё до просмотра.", icon: "✨", color: "#6366f1" },
          { num: "03", title: "Готовые посты для соцсетей", desc: "От объявления до поста в Instagram/Facebook автоматически. Ноль ручного дизайна.", icon: "📱", color: "#ec4899" },
          { num: "04", title: "Видео без видеографа", desc: "Промо-видео для каждого объекта за несколько кликов. Контент, который цепляет.", icon: "🎬", color: "#10b981" },
          { num: "05", title: "Цена за м² в реальном времени", desc: "Конкретные данные для оценок, приобретений и переговоров. Больше никаких примерных оценок.", icon: "📊", color: "#f97316" },
          { num: "06", title: "Умная карта района", desc: "Сервисы, транспорт, школы, парки — анализ по расстоянию и значимости.", icon: "🗺️", color: "#0ea5e9" },
        ],
      },
      testimonials: {
      ...
      howItWorks: {
        ...
        steps: [
          { step: "1", title: "Выберите план", desc: "Starter, Agency или Pro — то, что вам подходит.", color: "#f59e0b", bg: "#fffbeb", emoji: "🎯" },
          { step: "2", title: "Установите расширение", desc: "Один клик в Chrome Web Store. 5 секунд.", color: "#6366f1", bg: "#eef2ff", emoji: "🧩" },
          { step: "3", title: "Просматривайте и анализируйте", desc: "Откройте портал недвижимости — GetNearMe работает.", color: "#10b981", bg: "#ecfdf5", emoji: "✨" },
        ],
      },
      faq: {
        title: "Вопросы?",
      ...
      popups: [
        ...
        { icon: "🏠", text: "Марко из Милана сгенерировал 14 отчётов сегодня", time: "5 мин назад" },
        { icon: "⭐", text: "Агентство Росси перешло на план Pro", time: "18 мин назад" },
        { icon: "📈", text: "342 анализа недвижимости завершено сегодня", time: "" },
        { icon: "🎯", text: "Джулия из Рима экспортировала 8 PDF на этой неделе", time: "7 мин назад" },
        { icon: "💼", text: "Агентство из Турина только что зарегистрировалось", time: "2 мин назад" },
        { icon: "🏆", text: "GetNearMe используют более 200 агентств в Италии", time: "" },
        { icon: "📱", text: "Андреа из Болоньи создал 5 постов сегодня", time: "9 мин назад" },
  ...
  uk: {
    ...
    landing: {
      ...
      features: {
        ...
        items: [
          { num: "01", title: "Порівнюйте та закривайте швидше", desc: "Візуальне порівняння об'єктів пліч-о-пліч. Структуровані дані = швидші рішення.", icon: "⚡", color: "#f59e0b" },
          { num: "02", title: "ШІ-хоумстейджинг за 10с", desc: "Порожні кімнати → вмебльовані інтер'єри. До/після, що продають ще до перегляду.", icon: "✨", color: "#6366f1" },
          { num: "03", title: "Готові пости для соцмереж", desc: "Від оголошення до посту в Instagram/Facebook автоматично. Нуль ручного дизайну.", icon: "📱", color: "#ec4899" },
          { num: "04", title: "Відео без відеографа", desc: "Промо-відео для кожного об'єкта за кілька кліків. Контент, що чіпляє.", icon: "🎬", color: "#10b981" },
          { num: "05", title: "Ціна за м² в реальному часі", desc: "Конкретні дані для оцінок, придбань та переговорів. Більше ніяких приблизних оцінок.", icon: "📊", color: "#f97316" },
          { num: "06", title: "Розумна карта району", desc: "Сервіси, транспорт, школи, парки — аналіз за відстанню та значущістю.", icon: "🗺️", color: "#0ea5e9" },
        ],
      },
      testimonials: {
      ...
      howItWorks: {
        ...
        steps: [
          { step: "1", title: "Оберіть план", desc: "Starter, Agency або Pro — те, що вам підходить.", color: "#f59e0b", bg: "#fffbeb", emoji: "🎯" },
          { step: "2", title: "Встановіть розширення", desc: "Один клік у Chrome Web Store. 5 секунд.", color: "#6366f1", bg: "#eef2ff", emoji: "🧩" },
          { step: "3", title: "Переглядайте та аналізуйте", desc: "Відкрийте портал нерухомості — GetNearMe працює.", color: "#10b981", bg: "#ecfdf5", emoji: "✨" },
        ],
      },
      faq: {
        title: "Питання?",
      ...
      popups: [
        ...
        { icon: "🏠", text: "Марко з Мілана згенерував 14 звітів сьогодні", time: "5 хв тому" },
        { icon: "⭐", text: "Агентство Россі перейшло на план Pro", time: "18 хв тому" },
        { icon: "📈", text: "342 аналізи нерухомості завершено сьогодні", time: "" },
        { icon: "🎯", text: "Джулія з Рима експортувала 8 PDF цього тижня", time: "7 хв тому" },
        { icon: "💼", text: "Агентство з Турина щойно зареєструвалось", time: "2 хв тому" },
        { icon: "🏆", text: "GetNearMe використовують понад 200 агентств в Італії", time: "" },
        { icon: "📱", text: "Андреа з Болоньї створив 5 постів сьогодні", time: "9 хв тому" },
