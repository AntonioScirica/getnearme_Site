...
export const translations = {
  it: {
    ...
    landing: {
      ...
      hero: {
        badge: "",
        title1: "Un annuncio aperto.",
        title2: "Tutto il marketing già pronto.",
        desc: "GetNearMe è l'estensione Chrome che legge ogni annuncio e ti restituisce analisi del quartiere, homestaging AI, video promozionali e post social pronti. Senza mai uscire dal portale.",
        ctaPrimary: "Prova 7 giorni gratis →",
        ctaSecondary: "▶ Guarda la demo",
        stats: ["Chrome Store ★ 4.9", "40+ agenzie attive", "5 tool in 1", "GDPR compliant"],
      },
      problem: {
        emoji: "😩",
        title: "Fotografo, Canva, CapCut, Excel, ChatGPT. Cinque app aperte per un annuncio.",
        desc: "Ogni immobile ti costa ore tra raccolta dati sulla zona, grafica dei post, montaggio video e PDF da impaginare. E mentre tu salti da un tool all'altro, il cliente sceglie un'altra agenzia.",
      },
      solution: {
        emoji: "🚀",
        title: "Un'estensione. Tutti i contenuti che ti servono.",
        desc: "GetNearMe estrae i dati dell'annuncio, mappa i servizi del quartiere, arreda le stanze vuote con l'AI, genera video con avatar parlante e impagina post social con il tuo brand. Tutto mentre resti sul portale.",
      },
      features: {
        title: "Cinque tool in uno.",
        titleHighlight: "Dentro il browser.",
        subtitle: "Apri un annuncio su immobiliare.it, idealista.it o casa.it. GetNearMe fa il resto.",
        items: [
          { num: "01", title: "Mappa quartiere in un click", desc: "Scuole, trasporti, supermercati, parchi, sanità, ristoranti. Mappa interattiva con distanze reali per ogni immobile.", icon: "🗺️", color: "#0ea5e9" },
          { num: "02", title: "Prezzo al m² e confronti", desc: "Valori di mercato aggiornati per la zona, confronti side-by-side tra immobili, classe energetica estratta dall'annuncio.", icon: "📊", color: "#f59e0b" },
          { num: "03", title: "Homestaging AI in 10 secondi", desc: "Stanze vuote → ambienti arredati in 8 stili (moderno, neutro, cozy, family…). Il before/after che firma l'incarico.", icon: "✨", color: "#6366f1" },
          { num: "04", title: "Video promozionali completi", desc: "6 template: avatar parlante, sottotitoli karaoke, walkthrough, before/after, split screen. Musica sincronizzata, zero editing.", icon: "🎬", color: "#10b981" },
          { num: "05", title: "22 template × 4 piattaforme", desc: "Instagram, Facebook, TikTok, LinkedIn. Post, story, reel e quadrato già ottimizzati. Il tuo logo, i tuoi colori.", icon: "📱", color: "#ec4899" },
          { num: "06", title: "PDF white-label e team", desc: "Report professionali col tuo brand, condivisi con l'intera agenzia (fino a 5 agenti). Un'immagine coerente su ogni contenuto.", icon: "📄", color: "#f97316" },
        ],
      },
      testimonials: {
      ...
      howItWorks: {
        ...
        subtitle: "Nessun software da installare. Nessuna formazione. Zero imparare-a-usare.",
        steps: [
          ...
          { step: "3", title: "Raccogli i contenuti", desc: "Analisi zona, video, post social e PDF pronti. Scarica, condividi o pubblica.", color: "#10b981", bg: "#ecfdf5", emoji: "✨" },
        ],
      },
      faq: {
        title: "Domande?",
