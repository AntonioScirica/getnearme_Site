  ...
  it: {
    ...
    landing: {
      ...
      features: {
        ...
        items: [
          { num: "01", title: "Homestaging AI", desc: "Arreda stanze vuote, corregge la luce e libera gli ambienti in circa 10 secondi. Otto stili selezionabili, prima/dopo pronti per cliente o social. Sostituisce Photoshop e interior designer.", icon: "sparkles", color: "#6366f1" },
          { num: "02", title: "Video AI per l'immobile", desc: "Reel e video promozionali con avatar parlante, sottotitoli, walkthrough e before/after. Sei template, zero editing. Sostituisce CapCut, Premiere e video maker.", icon: "clapperboard", color: "#10b981" },
