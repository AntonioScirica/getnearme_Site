...
export const translations = {
  it: {
    ...
    landing: {
      ...
      problem: {
        emoji: "😩",
        title: "Le tue analisi le fai ancora con Excel e screenshot?",
        desc: "Ogni giorno perdi ore a raccogliere dati, incollare in documenti, cercare prezzi aggiornati. Il risultato? Presentazioni che non ti differenziano.",
      },
      solution: {
        emoji: "🚀",
        title: "GetNearMe automatizza tutto in un click.",
        desc: "Una estensione Chrome: analizza, confronta, genera PDF, crea contenuti social e usa l'AI per valorizzare ogni proprietà. Mentre navighi, lei lavora.",
      },
      features: {
        title: "Ogni funzione è un",
        titleHighlight: "vantaggio competitivo",
        subtitle: "6 strumenti. Un solo obiettivo: farti chiudere di più.",
        items: [
          { num: "01", title: "Confronta e chiudi prima", desc: "Confronto visivo side-by-side tra immobili. Dati strutturati = decisioni più rapide.", icon: "⚡", color: "#f59e0b" },
          { num: "02", title: "Homestaging AI in 10s", desc: "Stanze vuote → ambienti arredati. Before/after che vendono prima della visita.", icon: "✨", color: "#6366f1" },
          { num: "03", title: "Post social già pronti", desc: "Dall'annuncio al post Instagram/Facebook in automatico. Zero grafica manuale.", icon: "📱", color: "#ec4899" },
          { num: "04", title: "Video senza videomaker", desc: "Video promozionali per ogni immobile in pochi click. Contenuti che catturano.", icon: "🎬", color: "#10b981" },
          { num: "05", title: "Prezzo al m² live", desc: "Dati concreti per valutazioni, acquisizioni e trattative. Niente più stime a occhio.", icon: "📊", color: "#f97316" },
          { num: "06", title: "Mappa quartiere smart", desc: "Servizi, trasporti, scuole, aree verdi analizzate per distanza e rilevanza.", icon: "🗺️", color: "#0ea5e9" },
        ],
      },
      testimonials: {
        ...
        retentionValue: "94%",
        items: [
          { name: "Marco Bianchi", role: "Titolare — Immobiliare Bianchi, Milano", text: "Da quando uso GetNearMe i clienti mi chiedono come faccio a preparare presentazioni così dettagliate. Ho triplicato gli incarichi in 3 mesi.", avatar: "MB", color: "#f59e0b" },
          { name: "Laura Ferri", role: "Agente Senior — CasaViva, Roma", text: "L'homestaging AI è pazzesco. Mostro il prima/dopo e i proprietari firmano l'incarico seduta stante.", avatar: "LF", color: "#6366f1" },
          { name: "Alessandro Conti", role: "Direttore — Gruppo Conti RE, Torino", text: "Risparmiamo almeno 2 ore al giorno per agente. Con 8 persone in agenzia, fate voi i conti.", avatar: "AC", color: "#10b981" },
        ],
      },
      pricing: {
        ...
        plans: [
          {
            ...
            features: ["5 utenti inclusi", "Crediti illimitati", "Calcolo prezzo al m² in tempo reale", "Report illimitati con il tuo logo", "AI Rendering & Homestaging", "Template Post & Stories Social", "Editor Video per i social"],
          ...
          },
          {
            ...
            features: ["5 utenti inclusi", "Crediti illimitati", "Calcolo prezzo al m² in tempo reale", "Report illimitati con il tuo logo", "AI Rendering & Homestaging", "Template Post & Stories Social", "Editor Video per i social", "Supporto Prioritario"],
            extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Inizia 7 giorni gratis →",
          },
        ],
      },
      howItWorks: {
        ...
        subtitle: "Nessuna configurazione. Nessun software.",
        steps: [
          { step: "1", title: "Scegli il piano", desc: "Starter, Agency o Pro — quello che fa per te.", color: "#f59e0b", bg: "#fffbeb", emoji: "🎯" },
          { step: "2", title: "Installa l'estensione", desc: "Un click su Chrome Web Store. 5 secondi.", color: "#6366f1", bg: "#eef2ff", emoji: "🧩" },
          { step: "3", title: "Naviga e analizza", desc: "Apri un portale immobiliare e GetNearMe lavora.", color: "#10b981", bg: "#ecfdf5", emoji: "✨" },
        ],
      },
      faq: {
        title: "Domande?",
        ...
        items: [
          { q: "Posso provare prima di pagare?", a: "Sì. Hai 7 giorni di prova gratuita con export illimitati su tutti i piani. Cancelli in un click, zero addebiti." },
          { q: "Cosa succede dopo i 7 giorni?", a: "Si attiva l'abbonamento mensile. Puoi cambiare piano o cancellare in qualsiasi momento dal profilo." },
          { q: "I prezzi scontati sono per sempre?", a: "No. L'offerta lancio è temporanea. Chi si iscrive ora mantiene il prezzo scontato finché resta abbonato." },
          { q: "Serve installare software?", a: "No. GetNearMe è un'estensione Chrome. Si installa in 5 secondi e funziona sui portali immobiliari che già usi." },
          { q: "Posso aggiungere agenti?", a: "Sì. Agency e Pro includono 5 utenti. Puoi aggiungerne altri a partire da 12€/mese ciascuno." },
          { q: "Posso usare il mio logo nei PDF?", a: "Sì, con il piano Pro. Starter e Agency usano il brand GetNearMe." },
        ],
      },
      finalCta: {
        title1: "Il tuo prossimo incarico",
        title2: "parte da qui.",
      ...
      popups: [
        ...
        { icon: "🏠", text: "Marco da Milano ha generato 14 report oggi", time: "5 min fa" },
        { icon: "⭐", text: "Agenzia Immobiliare Rossi ha fatto upgrade al piano Pro", time: "18 min fa" },
        { icon: "📈", text: "342 analisi immobiliari completate oggi", time: "" },
        { icon: "🎯", text: "Giulia da Roma ha esportato 8 PDF questa settimana", time: "7 min fa" },
        { icon: "💼", text: "Un'agenzia di Torino si è appena registrata", time: "2 min fa" },
        { icon: "🏆", text: "GetNearMe è usato da oltre 200 agenzie in Italia", time: "" },
        { icon: "📱", text: "Andrea da Bologna ha creato 5 post social oggi", time: "9 min fa" },
      ],
    },
  },
  en: {
