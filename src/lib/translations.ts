      ...
      pricing: {
        ...
        plans: [
          ...
          },
          {
            ...
            savingsYear: null, badge: null, popular: false,
            features: ["250 foto AI homestaging/mese", "6 video AI/mese", "Post social illimitati", "Montaggio Illimitato", "Report Automatici", "Analisi della zona", "Import immobili", "Supporto prioritario"],
      ...
      pricing: {
        ...
        plans: [
          ...
          },
          {
            ...
            savingsYear: null, badge: null, popular: false,
            features: ["250 AI homestaging photos/month", "6 AI videos/month", "Unlimited social posts & stories", "Automatic Video Editor", "100% Branded Content", "Priority support"],
          ...
          },
          {
            ...
            features: ["250 AI homestaging photos/month", "6 AI videos/month", "Unlimited social posts & stories", "Automatic Video Editor", "100% Branded Content", "Priority support", "2 months free"],
            extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Choose this plan",
          },
        ],
        plansByTier: {
      ...
      pricing: {
        ...
        plans: [
          ...
          },
          {
            ...
            savingsYear: null, badge: null, popular: false,
            features: ["250 fotos AI homestaging/mes", "6 videos AI/mes", "Posts y stories social ilimitados", "Editor de Video Automático", "Contenidos 100% Personalizados", "Soporte prioritario"],
          ...
          },
          {
            ...
            features: ["250 fotos AI homestaging/mes", "6 videos AI/mes", "Posts y stories social ilimitados", "Editor de Video Automático", "Contenidos 100% Personalizados", "Soporte prioritario", "2 meses gratis"],
            extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Elige este plan",
          },
        ],
        plansByTier: {
      ...
      pricing: {
        ...
        plans: [
          ...
          },
          {
            ...
            savingsYear: null, badge: null, popular: false,
            features: ["250 photos AI homestaging/mois", "6 vidéos AI/mois", "Posts et stories social illimités", "Éditeur Vidéo Automatique", "Contenus 100% Personnalisés", "Support prioritaire"],
          ...
          },
          {
            ...
            features: ["250 photos AI homestaging/mois", "6 vidéos AI/mois", "Posts et stories social illimités", "Éditeur Vidéo Automatique", "Contenus 100% Personnalisés", "Support prioritaire", "2 mois gratuits"],
            extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Choisir ce plan",
          },
        ],
        plansByTier: {
      ...
      pricing: {
        ...
        plans: [
          ...
          },
          {
            ...
            savingsYear: null, badge: null, popular: false,
            features: ["250 фото AI homestaging/месяц", "6 AI видео/месяц", "Безлимитные посты и сторис", "Автоматический Видеоредактор", "100% Брендированный Контент", "Приоритетная поддержка"],
          ...
          },
          {
            ...
            features: ["250 фото AI homestaging/месяц", "6 AI видео/месяц", "Безлимитные посты и сторис", "Автоматический Видеоредактор", "100% Брендированный Контент", "Приоритетная поддержка", "2 месяца бесплатно"],
            extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Выбрать этот план",
          },
        ],
        plansByTier: {
