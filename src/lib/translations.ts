  ...
  it: {
    ...
    landing: {
      ...
      modal: {
        ...
        title: "Ottima scelta!",
        planLabel: "Piano",
        desc: "Installa l'estensione Chrome per attivare i tuoi",
        descBold: "7 giorni di prova gratuita",
        descEnd: "con export illimitati.",
        cta: "Installa su Chrome →",
  ...
  en: {
    ...
    landing: {
      ...
      modal: {
        ...
        title: "Great choice!",
        planLabel: "Plan",
        desc: "Install the Chrome extension to activate your",
  ...
  es: {
    ...
    landing: {
      ...
      modal: {
        ...
        title: "¡Gran elección!",
        planLabel: "Plan",
        desc: "Instala la extensión de Chrome para activar tus",
  ...
  fr: {
    ...
    landing: {
      ...
      modal: {
        ...
        planLabel: "Plan",
        desc: "Installez l'extension Chrome pour activer vos",
  ...
  ru: {
    ...
    landing: {
      ...
      modal: {
        ...
        planLabel: "План",
        desc: "Установите расширение Chrome, чтобы активировать",
