...
export const translations = {
  it: {
    ...
    landing: {
      ...
      hero: {
        badge: "",
        title1: "L'assistente dell'agente",
        title2: "che fa la differenza col cliente.",
        desc: "GetNearMe è l'estensione Chrome che ti aiuta a presentare ogni immobile come merita: homestaging AI, video con avatar, contenuti per i tuoi canali e informazioni di quartiere. Dai al cliente un'esperienza che ricorda — e che ne porta altri.",
        ctaPrimary: "Prova 7 giorni gratis →",
        ctaSecondary: "▶ Guarda la demo",
        stats: ["Chrome Store ★ 4.9", "40+ agenzie attive", "Pronto all'uso", "GDPR compliant"],
      },
      problem: {
        emoji: "frown",
        title: "I clienti oggi si aspettano di più — e si ricordano chi glielo dà.",
        desc: "Foto mediocri, descrizioni generiche, zero contesto sul quartiere: così l'immobile passa inosservato e il cliente va altrove. Tenere alto lo standard su ogni incarico richiede ore che non hai, e strumenti che costano e non si parlano tra loro.",
      },
      solution: {
        emoji: "rocket",
        title: "Un'estensione. Un'esperienza da ricordare, per ogni cliente.",
        desc: "GetNearMe ti aiuta a curare ogni dettaglio — dalla foto ben valorizzata al video di presentazione, dal contesto del quartiere ai contenuti per i tuoi canali. Con lo stesso sforzo di prima offri un servizio che fidelizza i clienti e porta i loro conoscenti a chiamare te.",
      },
      features: {
        title: "Cinque strumenti in uno.",
        titleHighlight: "Dentro il browser.",
        subtitle: "Apri un annuncio su immobiliare.it, idealista.it o casa.it. GetNearMe ti dà quello che serve per fare bella figura col cliente.",
        items: [
          { num: "01", title: "Il quartiere raccontato bene", desc: "Scuole, trasporti, supermercati, parchi, sanità, ristoranti a portata di click. Mostra al cliente cosa vuol dire davvero vivere lì.", icon: "map", color: "#0ea5e9" },
          { num: "02", title: "Report white-label e team", desc: "Presentazioni professionali col tuo brand, condivise con l'intera agenzia (fino a 5 agenti). Un'immagine coerente verso ogni cliente.", icon: "file-text", color: "#f97316" },
          { num: "03", title: "Homestaging AI in 10 secondi", desc: "Stanze vuote → ambienti arredati in 8 stili. Il before/after che convince il proprietario a firmare con te.", icon: "sparkles", color: "#6366f1" },
          { num: "04", title: "Presentazioni video per il cliente", desc: "6 template: avatar parlante, sottotitoli, walkthrough, before/after. Racconta l'immobile in modo professionale, senza editing.", icon: "clapperboard", color: "#10b981" },
          { num: "05", title: "Contenuti pronti per ogni canale", desc: "30+ layout ottimizzati per i canali dove i tuoi clienti ti trovano. Il tuo logo, i tuoi colori, la tua identità.", icon: "smartphone", color: "#ec4899" },
          { num: "06", title: "Valore al m² sempre sotto mano", desc: "Valori di mercato aggiornati per la zona e confronti tra immobili, per parlare di prezzo con sicurezza davanti al cliente.", icon: "trending-up", color: "#f59e0b" },
        ],
      },
      testimonials: {
        ...
        npsLabel: "NPS medio",
        npsValue: "72",
        retentionLabel: "Retention 90gg",
        retentionValue: "94%",
        items: [
          { name: "Marco Bianchi", role: "Titolare — Immobiliare Bianchi, Milano", text: "Prima saltavo tra Canva, CapCut e tre Google Maps aperti. Adesso apro un annuncio e mi ritrovo video, post Instagram e PDF pronti. Ho triplicato gli incarichi in 3 mesi.", avatar: "MB", color: "#f59e0b" },
          { name: "Laura Ferri", role: "Agente Senior — CasaViva, Roma", text: "L'homestaging AI è l'arma segreta. Mostro la stanza vuota, poi arredata in 10 secondi. Il proprietario firma l'incarico prima di uscire dal mio ufficio.", avatar: "LF", color: "#6366f1" },
          { name: "Alessandro Conti", role: "Direttore — Gruppo Conti RE, Torino", text: "Con 8 agenti risparmiamo circa 16 ore al giorno. Più contenuti pubblicati, più incarichi, meno stress. Non c'è paragone con il metodo vecchio.", avatar: "AC", color: "#10b981" },
        ],
      },
      pricing: {
        title1: "Scegli il piano.",
        title2: "Prova tutto",
        titleHighlight: "gratis per 7 giorni",
        subtitle: "Export illimitati durante la prova. Nessun vincolo. Cancelli quando vuoi.",
        ...
        plans: [
          {
            ...
            features: ["5 agenti inclusi", "Analisi quartiere illimitate", "Prezzo al m² e confronti", "Homestaging AI (500 foto/mese)", "Video AI con avatar e sottotitoli", "22 template social × 4 piattaforme", "PDF white-label col tuo logo"],
          ...
          },
          {
            ...
            savingsYear: null, badge: "Più venduto", popular: false,
            features: ["5 agenti inclusi", "Analisi quartiere illimitate", "Prezzo al m² e confronti", "Homestaging AI (1.500 foto/mese)", "Video AI con avatar e sottotitoli", "22 template social × 4 piattaforme", "PDF white-label col tuo logo", "Supporto prioritario"],
            extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Inizia 7 giorni gratis →",
          },
        ],
      },
      howItWorks: {
        title: "Attivo in",
        titleHighlight: "30 secondi",
        subtitle: "Nessun software da installare. Nessuna formazione. Sei operativo da subito.",
        steps: [
          { step: "1", title: "Aggiungi a Chrome", desc: "Un click dallo Store. L'estensione si installa nel browser in pochi secondi.", color: "#6366f1", bg: "#eef2ff", emoji: "puzzle" },
          { step: "2", title: "Apri un annuncio", desc: "immobiliare.it, idealista.it o casa.it — i portali dove già lavori ogni giorno.", color: "#f59e0b", bg: "#fffbeb", emoji: "search" },
          { step: "3", title: "Presenta al cliente", desc: "Foto valorizzate, video, contesto del quartiere e report pronti. Tutto quello che ti serve per fare bella figura.", color: "#10b981", bg: "#ecfdf5", emoji: "sparkles" },
        ],
      },
      faq: {
        title: "Domande?",
        ...
        items: [
          { q: "Su quali portali funziona?", a: "Su immobiliare.it, idealista.it e casa.it. Basta aprire un annuncio: GetNearMe si attiva in automatico e legge i dati dell'immobile." },
          { q: "Cosa riesco a fare concretamente con un solo annuncio aperto?", a: "Ottieni la mappa dei servizi del quartiere, il prezzo al m² della zona, foto arredate con AI, un video promozionale, post per Instagram/Facebook/TikTok/LinkedIn e un PDF col tuo logo. Tutto senza chiudere il portale." },
          { q: "L'homestaging AI modifica davvero le foto?", a: "Sì. Scegli la foto della stanza vuota (o semivuota), uno degli 8 stili e l'AI arreda l'ambiente in circa 10 secondi. Puoi poi usare il prima/dopo nei post social o nei video." },
          { q: "Posso creare video senza saper montare?", a: "Sì. Scegli uno dei 6 template (avatar parlante, sottotitoli karaoke, walkthrough, before/after, split screen, staging video) e GetNearMe monta musica, testi e clip. Non servono software di editing." },
          { q: "Posso usare il mio logo ovunque?", a: "Sì. Carichi il logo una volta e viene applicato su PDF, outro dei video e post social. Vale per tutti gli agenti dell'agenzia." },
          { q: "Quanti agenti posso aggiungere?", a: "Ogni piano include 5 agenti, con crediti condivisi e stesso branding. Ogni agente ha il proprio account ma lavora sotto lo stesso marchio." },
          { q: "Posso provare prima di pagare?", a: "Sì: 7 giorni di prova gratuita con export illimitati. Cancelli con un click, zero addebiti." },
        ],
      },
      finalCta: {
        title1: "Il prossimo annuncio",
        title2: "te lo presenta GetNearMe.",
        desc: "7 giorni gratis. Tutti i tool inclusi. Zero rischi.",
        button: "Inizia ora →",
        footer: "Unisciti alle 40+ agenzie che hanno smesso di saltare tra cinque app",
      },
      modal: {
        emoji: "rocket",
        title: "Ottima scelta!",
        ...
        descEnd: "con export illimitati.",
        cta: "Abbonati ora →",
        footer: "🔒 Nessun addebito. Cancelli in qualsiasi momento.",
      },
      popups: [
        { icon: "circle", text: "Luca da Firenze ha attivato il piano Agency", time: "3 min fa" },
        { icon: "clapperboard", text: "Un agente ha appena generato un video promozionale", time: "" },
        { icon: "users", text: "6 agenzie online in questo momento", time: "" },
        { icon: "rocket", text: "Maria da Napoli ha iniziato la prova gratuita", time: "12 min fa" },
        { icon: "flame", text: "9 agenzie hanno scelto GetNearMe questo mese", time: "" },
        { icon: "sparkles", text: "Marco da Milano ha arredato 14 stanze con l'AI oggi", time: "5 min fa" },
        { icon: "star", text: "Agenzia Immobiliare Rossi ha fatto upgrade al piano Annuale", time: "18 min fa" },
        { icon: "smartphone", text: "127 post social creati questa settimana", time: "" },
        { icon: "target", text: "Giulia da Roma ha esportato 8 PDF white-label", time: "7 min fa" },
        { icon: "briefcase", text: "Un'agenzia di Torino si è appena registrata", time: "2 min fa" },
        { icon: "trophy", text: "GetNearMe usato da oltre 200 agenti in Italia", time: "" },
        { icon: "map", text: "Andrea da Bologna ha generato 5 analisi di quartiere oggi", time: "9 min fa" },
      ],
    },
  },
  en: {
    ...
    landing: {
      ...
      problem: {
        emoji: "frown",
        title: "Still doing your analysis with Excel and screenshots?",
        desc: "Every day you waste hours collecting data, pasting into documents, searching for updated prices. The result? Presentations that don't set you apart.",
      },
      solution: {
        emoji: "rocket",
        title: "GetNearMe automates everything in one click.",
        desc: "A Chrome extension: analyze, compare, generate PDFs, create social content and use AI to enhance every property. While you browse, it works.",
      },
      features: {
        title: "Every feature is a",
        titleHighlight: "competitive advantage",
        subtitle: "6 tools. One goal: help you close more deals.",
        items: [
          { num: "01", title: "Compare and close faster", desc: "Visual side-by-side property comparison. Structured data = faster decisions.", icon: "zap", color: "#f59e0b" },
          { num: "02", title: "AI Homestaging in 10s", desc: "Empty rooms → furnished spaces. Before/after that sell before the visit.", icon: "sparkles", color: "#6366f1" },
          { num: "03", title: "Ready-made social posts", desc: "From listing to Instagram/Facebook post automatically. Zero manual design.", icon: "smartphone", color: "#ec4899" },
          { num: "04", title: "Videos without a videographer", desc: "Promotional videos for every property in a few clicks. Content that captures.", icon: "clapperboard", color: "#10b981" },
          { num: "05", title: "Live price per m²", desc: "Concrete data for valuations, acquisitions and negotiations. No more guesswork.", icon: "bar-chart", color: "#f97316" },
          { num: "06", title: "Smart neighborhood map", desc: "Services, transport, schools, green areas analyzed by distance and relevance.", icon: "map", color: "#0ea5e9" },
        ],
      },
      testimonials: {
        title: "Those who use it never go back.",
        npsLabel: "Average NPS",
        npsValue: "72",
      ...
      pricing: {
        ...
        title2: "Try everything",
        titleHighlight: "free for 7 days",
        subtitle: "Unlimited exports during the trial. No strings attached. Cancel anytime.",
        ...
        plans: [
          {
            ...
            savingsYear: null, badge: null, popular: false,
            features: ["5 users included", "Unlimited credits", "Real-time price per m² calculation", "Unlimited reports with your logo", "AI Rendering & Homestaging", "Social Post & Stories Templates", "Social Video Editor"],
          ...
          },
          {
            ...
            savingsYear: null, badge: "Best seller", popular: false,
            features: ["5 users included", "Unlimited credits", "Real-time price per m² calculation", "Unlimited reports with your logo", "AI Rendering & Homestaging", "Social Post & Stories Templates", "Social Video Editor", "Priority Support"],
            extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Start 7-day free trial →",
          },
        ],
      },
      howItWorks: {
        ...
        subtitle: "No setup. No software.",
        steps: [
          { step: "1", title: "Choose your plan", desc: "Starter, Agency or Pro — the one that fits you.", color: "#f59e0b", bg: "#fffbeb", emoji: "target" },
          { step: "2", title: "Install the extension", desc: "One click on Chrome Web Store. 5 seconds.", color: "#6366f1", bg: "#eef2ff", emoji: "puzzle" },
          { step: "3", title: "Browse and analyze", desc: "Open a property portal and GetNearMe works.", color: "#10b981", bg: "#ecfdf5", emoji: "sparkles" },
        ],
      },
      faq: {
        title: "Questions?",
        ...
        items: [
          { q: "Can I try before paying?", a: "Yes. You get 7 days of free trial with unlimited exports on all plans. Cancel in one click, zero charges." },
          { q: "What happens after 7 days?", a: "Your monthly subscription activates. You can change plans or cancel at any time from your profile." },
          { q: "Are the discounted prices forever?", a: "No. The launch offer is temporary. Those who sign up now keep the discounted price as long as they stay subscribed." },
          { q: "Do I need to install software?", a: "No. GetNearMe is a Chrome extension. It installs in 5 seconds and works on the property portals you already use." },
          { q: "Can I add more agents?", a: "Yes. Agency and Pro include 5 users. You can add more starting at €12/month each." },
          { q: "Can I use my own logo on PDFs?", a: "Yes, with the Pro plan. Starter and Agency use the GetNearMe brand." },
        ],
      },
      finalCta: {
        title1: "Your next listing",
        title2: "starts here.",
      ...
      modal: {
        ...
        descEnd: "with unlimited exports.",
        cta: "Subscribe now →",
        footer: "🔒 No charges. Cancel anytime.",
      },
      popups: [
        { icon: "circle", text: "Luca from Florence activated the Agency plan", time: "3 min ago" },
        { icon: "bar-chart", text: "127 reports generated this week", time: "" },
        { icon: "users", text: "6 agencies online right now", time: "" },
        { icon: "home", text: "Marco from Milan generated 14 reports today", time: "5 min ago" },
        { icon: "star", text: "Rossi Real Estate upgraded to the Pro plan", time: "18 min ago" },
        { icon: "trending-up", text: "342 property analyses completed today", time: "" },
        { icon: "target", text: "Giulia from Rome exported 8 PDFs this week", time: "7 min ago" },
        { icon: "briefcase", text: "An agency from Turin just signed up", time: "2 min ago" },
        { icon: "trophy", text: "GetNearMe is used by 200+ agencies in Italy", time: "" },
        { icon: "smartphone", text: "Andrea from Bologna created 5 social posts today", time: "9 min ago" },
        { icon: "rocket", text: "Maria from Naples started the free trial", time: "12 min ago" },
        { icon: "flame", text: "9 agencies chose GetNearMe this month", time: "" },
      ],
    },
  },
  es: {
    ...
    landing: {
      topBar: {
        promo: "Oferta de lanzamiento: hasta",
      ...
      problem: {
        emoji: "frown",
        title: "¿Todavía haces tus análisis con Excel y capturas de pantalla?",
        desc: "Cada día pierdes horas recopilando datos, pegándolos en documentos, buscando precios actualizados. ¿El resultado? Presentaciones que no te diferencian.",
      },
      solution: {
        emoji: "rocket",
        title: "GetNearMe automatiza todo en un clic.",
        desc: "Una extensión de Chrome: analiza, compara, genera PDF, crea contenido social y usa IA para valorizar cada propiedad. Mientras navegas, ella trabaja.",
      },
      features: {
        title: "Cada función es una",
        titleHighlight: "ventaja competitiva",
        subtitle: "6 herramientas. Un solo objetivo: ayudarte a cerrar más.",
        items: [
          { num: "01", title: "Compara y cierra antes", desc: "Comparación visual lado a lado entre inmuebles. Datos estructurados = decisiones más rápidas.", icon: "zap", color: "#f59e0b" },
          { num: "02", title: "Homestaging IA en 10s", desc: "Habitaciones vacías → ambientes amueblados. Antes/después que venden antes de la visita.", icon: "sparkles", color: "#6366f1" },
          { num: "03", title: "Posts sociales ya listos", desc: "Del anuncio al post de Instagram/Facebook automáticamente. Cero diseño manual.", icon: "smartphone", color: "#ec4899" },
          { num: "04", title: "Vídeos sin videógrafo", desc: "Vídeos promocionales para cada inmueble en pocos clics. Contenido que cautiva.", icon: "clapperboard", color: "#10b981" },
          { num: "05", title: "Precio por m² en vivo", desc: "Datos concretos para valoraciones, adquisiciones y negociaciones. Sin más estimaciones a ojo.", icon: "bar-chart", color: "#f97316" },
          { num: "06", title: "Mapa de barrio inteligente", desc: "Servicios, transporte, colegios, zonas verdes analizados por distancia y relevancia.", icon: "map", color: "#0ea5e9" },
        ],
      },
      testimonials: {
        title: "Quien lo usa, no vuelve atrás.",
        npsLabel: "NPS medio",
        npsValue: "72",
      ...
      pricing: {
        ...
        title2: "Prueba todo",
        titleHighlight: "gratis durante 7 días",
        subtitle: "Exportaciones ilimitadas durante la prueba. Sin compromiso. Cancela cuando quieras.",
        ...
        plans: [
          {
            ...
            savingsYear: null, badge: null, popular: false,
            features: ["5 usuarios incluidos", "Créditos ilimitados", "Cálculo de precio por m² en tiempo real", "Informes ilimitados con tu logo", "AI Rendering & Homestaging", "Plantillas Post & Stories Social", "Editor de Vídeo Social"],
          ...
          },
          {
            ...
            savingsYear: null, badge: "Más vendido", popular: false,
            features: ["5 usuarios incluidos", "Créditos ilimitados", "Cálculo de precio por m² en tiempo real", "Informes ilimitados con tu logo", "AI Rendering & Homestaging", "Plantillas Post & Stories Social", "Editor de Vídeo Social", "Soporte Prioritario"],
            extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Empieza 7 días gratis →",
          },
        ],
      },
      howItWorks: {
        ...
        subtitle: "Sin configuración. Sin software.",
        steps: [
          { step: "1", title: "Elige tu plan", desc: "Starter, Agency o Pro — el que mejor se adapte.", color: "#f59e0b", bg: "#fffbeb", emoji: "target" },
          { step: "2", title: "Instala la extensión", desc: "Un clic en Chrome Web Store. 5 segundos.", color: "#6366f1", bg: "#eef2ff", emoji: "puzzle" },
          { step: "3", title: "Navega y analiza", desc: "Abre un portal inmobiliario y GetNearMe trabaja.", color: "#10b981", bg: "#ecfdf5", emoji: "sparkles" },
        ],
      },
      faq: {
        title: "¿Preguntas?",
        ...
        items: [
          { q: "¿Puedo probar antes de pagar?", a: "Sí. Tienes 7 días de prueba gratuita con exportaciones ilimitadas en todos los planes. Cancelas en un clic, cero cargos." },
          { q: "¿Qué pasa después de los 7 días?", a: "Se activa la suscripción mensual. Puedes cambiar de plan o cancelar en cualquier momento desde tu perfil." },
          { q: "¿Los precios con descuento son para siempre?", a: "No. La oferta de lanzamiento es temporal. Quien se registre ahora mantiene el precio con descuento mientras siga suscrito." },
          { q: "¿Necesito instalar software?", a: "No. GetNearMe es una extensión de Chrome. Se instala en 5 segundos y funciona en los portales inmobiliarios que ya usas." },
          { q: "¿Puedo añadir más agentes?", a: "Sí. Agency y Pro incluyen 5 usuarios. Puedes añadir más a partir de 12€/mes cada uno." },
          { q: "¿Puedo usar mi logo en los PDF?", a: "Sí, con el plan Pro. Starter y Agency usan la marca GetNearMe." },
        ],
      },
      finalCta: {
        title1: "Tu próxima captación",
        title2: "empieza aquí.",
      ...
      modal: {
        ...
        descEnd: "con exportaciones ilimitadas.",
        cta: "Suscríbete ahora →",
        footer: "🔒 Sin cargos. Cancela en cualquier momento.",
      },
      popups: [
        { icon: "circle", text: "Luca de Florencia activó el plan Agency", time: "hace 3 min" },
        { icon: "bar-chart", text: "127 informes generados esta semana", time: "" },
        { icon: "users", text: "6 agencias online en este momento", time: "" },
        { icon: "home", text: "Marco de Milán generó 14 informes hoy", time: "hace 5 min" },
        { icon: "star", text: "Inmobiliaria Rossi pasó al plan Pro", time: "hace 18 min" },
        { icon: "trending-up", text: "342 análisis inmobiliarios completados hoy", time: "" },
        { icon: "target", text: "Giulia de Roma exportó 8 PDFs esta semana", time: "hace 7 min" },
        { icon: "briefcase", text: "Una agencia de Turín acaba de registrarse", time: "hace 2 min" },
        { icon: "trophy", text: "GetNearMe es usado por más de 200 agencias en Italia", time: "" },
        { icon: "smartphone", text: "Andrea de Bolonia creó 5 posts sociales hoy", time: "hace 9 min" },
        { icon: "rocket", text: "Maria de Nápoles empezó la prueba gratuita", time: "hace 12 min" },
        { icon: "flame", text: "9 agencias eligieron GetNearMe este mes", time: "" },
      ],
    },
  },
  fr: {
    ...
    landing: {
      topBar: {
        promo: "Offre de lancement : jusqu'à",
      ...
      problem: {
        emoji: "frown",
        title: "Vous faites encore vos analyses avec Excel et des captures d'écran ?",
        desc: "Chaque jour, vous perdez des heures à collecter des données, coller dans des documents, chercher des prix à jour. Le résultat ? Des présentations qui ne vous démarquent pas.",
      },
      solution: {
        emoji: "rocket",
        title: "GetNearMe automatise tout en un clic.",
        desc: "Une extension Chrome : analyse, compare, génère des PDF, crée du contenu social et utilise l'IA pour valoriser chaque bien. Pendant que vous naviguez, elle travaille.",
      },
      features: {
        title: "Chaque fonction est un",
        titleHighlight: "avantage concurrentiel",
        subtitle: "6 outils. Un seul objectif : vous aider à conclure plus.",
        items: [
          { num: "01", title: "Comparez et concluez plus vite", desc: "Comparaison visuelle côte à côte des biens. Données structurées = décisions plus rapides.", icon: "zap", color: "#f59e0b" },
          { num: "02", title: "Homestaging IA en 10s", desc: "Pièces vides → espaces meublés. Avant/après qui vendent avant la visite.", icon: "sparkles", color: "#6366f1" },
          { num: "03", title: "Posts sociaux déjà prêts", desc: "De l'annonce au post Instagram/Facebook automatiquement. Zéro design manuel.", icon: "smartphone", color: "#ec4899" },
          { num: "04", title: "Vidéos sans vidéaste", desc: "Vidéos promotionnelles pour chaque bien en quelques clics. Du contenu qui captive.", icon: "clapperboard", color: "#10b981" },
          { num: "05", title: "Prix au m² en direct", desc: "Données concrètes pour évaluations, acquisitions et négociations. Fini les estimations au doigt mouillé.", icon: "bar-chart", color: "#f97316" },
          { num: "06", title: "Carte de quartier intelligente", desc: "Services, transports, écoles, espaces verts analysés par distance et pertinence.", icon: "map", color: "#0ea5e9" },
        ],
      },
      testimonials: {
        title: "Ceux qui l'utilisent ne reviennent plus en arrière.",
        npsLabel: "NPS moyen",
        npsValue: "72",
      ...
      pricing: {
        title1: "Choisissez votre plan.",
        title2: "Essayez tout",
        titleHighlight: "gratuitement pendant 7 jours",
        subtitle: "Exports illimités pendant l'essai. Sans engagement. Annulez quand vous voulez.",
        ...
        plans: [
          {
            ...
            savingsYear: null, badge: null, popular: false,
            features: ["5 utilisateurs inclus", "Crédits illimités", "Calcul du prix au m² en temps réel", "Rapports illimités avec votre logo", "AI Rendering & Homestaging", "Templates Post & Stories Social", "Éditeur Vidéo Social"],
          ...
          },
          {
            ...
            savingsYear: null, badge: "Best-seller", popular: false,
            features: ["5 utilisateurs inclus", "Crédits illimités", "Calcul du prix au m² en temps réel", "Rapports illimités avec votre logo", "AI Rendering & Homestaging", "Templates Post & Stories Social", "Éditeur Vidéo Social", "Support Prioritaire"],
            extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Commencer 7 jours gratuits →",
          },
        ],
      },
      howItWorks: {
        ...
        subtitle: "Aucune configuration. Aucun logiciel.",
        steps: [
          { step: "1", title: "Choisissez votre plan", desc: "Starter, Agency ou Pro — celui qui vous convient.", color: "#f59e0b", bg: "#fffbeb", emoji: "target" },
          { step: "2", title: "Installez l'extension", desc: "Un clic sur Chrome Web Store. 5 secondes.", color: "#6366f1", bg: "#eef2ff", emoji: "puzzle" },
          { step: "3", title: "Naviguez et analysez", desc: "Ouvrez un portail immobilier et GetNearMe travaille.", color: "#10b981", bg: "#ecfdf5", emoji: "sparkles" },
        ],
      },
      faq: {
        title: "Questions ?",
        ...
        items: [
          { q: "Puis-je essayer avant de payer ?", a: "Oui. Vous avez 7 jours d'essai gratuit avec exports illimités sur tous les plans. Annulez en un clic, zéro frais." },
          { q: "Que se passe-t-il après les 7 jours ?", a: "L'abonnement mensuel s'active. Vous pouvez changer de plan ou annuler à tout moment depuis votre profil." },
          { q: "Les prix réduits sont-ils permanents ?", a: "Non. L'offre de lancement est temporaire. Ceux qui s'inscrivent maintenant conservent le prix réduit tant qu'ils restent abonnés." },
          { q: "Faut-il installer un logiciel ?", a: "Non. GetNearMe est une extension Chrome. Elle s'installe en 5 secondes et fonctionne sur les portails immobiliers que vous utilisez déjà." },
          { q: "Puis-je ajouter des agents ?", a: "Oui. Agency et Pro incluent 5 utilisateurs. Vous pouvez en ajouter à partir de 12€/mois chacun." },
          { q: "Puis-je utiliser mon logo sur les PDF ?", a: "Oui, avec le plan Pro. Starter et Agency utilisent la marque GetNearMe." },
        ],
      },
      finalCta: {
        title1: "Votre prochain mandat",
        title2: "commence ici.",
      ...
      modal: {
        ...
        planLabel: "Plan",
        desc: "Connectez-vous ou inscrivez-vous pour activer vos",
        descBold: "7 jours d'essai gratuit",
        descEnd: "avec exports illimités.",
        cta: "S'abonner maintenant →",
        footer: "🔒 Aucun prélèvement. Annulez à tout moment.",
      },
      popups: [
        { icon: "circle", text: "Luca de Florence a activé le plan Agency", time: "il y a 3 min" },
        { icon: "bar-chart", text: "127 rapports générés cette semaine", time: "" },
        { icon: "users", text: "6 agences en ligne en ce moment", time: "" },
        { icon: "home", text: "Marco de Milan a généré 14 rapports aujourd'hui", time: "il y a 5 min" },
        { icon: "star", text: "Agence Immobilière Rossi est passée au plan Pro", time: "il y a 18 min" },
        { icon: "trending-up", text: "342 analyses immobilières complétées aujourd'hui", time: "" },
        { icon: "target", text: "Giulia de Rome a exporté 8 PDFs cette semaine", time: "il y a 7 min" },
        { icon: "briefcase", text: "Une agence de Turin vient de s'inscrire", time: "il y a 2 min" },
        { icon: "trophy", text: "GetNearMe est utilisé par plus de 200 agences en Italie", time: "" },
        { icon: "smartphone", text: "Andrea de Bologne a créé 5 posts sociaux aujourd'hui", time: "il y a 9 min" },
        { icon: "rocket", text: "Maria de Naples a commencé l'essai gratuit", time: "il y a 12 min" },
        { icon: "flame", text: "9 agences ont choisi GetNearMe ce mois-ci", time: "" },
      ],
    },
  },
  ru: {
    ...
    landing: {
      topBar: {
        promo: "Стартовое предложение: до",
        discount: "60% скидка",
      ...
      problem: {
        emoji: "frown",
        title: "Всё ещё делаете анализ в Excel и скриншотах?",
        desc: "Каждый день вы тратите часы на сбор данных, вставку в документы, поиск актуальных цен. Результат? Презентации, которые не выделяют вас.",
      },
      solution: {
        emoji: "rocket",
        title: "GetNearMe автоматизирует всё в один клик.",
        desc: "Расширение Chrome: анализирует, сравнивает, генерирует PDF, создаёт контент для соцсетей и использует ИИ для повышения ценности каждого объекта. Пока вы просматриваете — оно работает.",
      },
      features: {
        title: "Каждая функция — это",
        titleHighlight: "конкурентное преимущество",
        subtitle: "6 инструментов. Одна цель: помочь вам закрывать больше сделок.",
        items: [
          { num: "01", title: "Сравнивайте и закрывайте быстрее", desc: "Визуальное сравнение объектов бок о бок. Структурированные данные = быстрые решения.", icon: "zap", color: "#f59e0b" },
          { num: "02", title: "ИИ-хоумстейджинг за 10с", desc: "Пустые комнаты → обставленные интерьеры. До/после, которые продают ещё до просмотра.", icon: "sparkles", color: "#6366f1" },
          { num: "03", title: "Готовые посты для соцсетей", desc: "От объявления до поста в Instagram/Facebook автоматически. Ноль ручного дизайна.", icon: "smartphone", color: "#ec4899" },
          { num: "04", title: "Видео без видеографа", desc: "Промо-видео для каждого объекта за несколько кликов. Контент, который цепляет.", icon: "clapperboard", color: "#10b981" },
          { num: "05", title: "Цена за м² в реальном времени", desc: "Конкретные данные для оценок, приобретений и переговоров. Больше никаких примерных оценок.", icon: "bar-chart", color: "#f97316" },
          { num: "06", title: "Умная карта района", desc: "Сервисы, транспорт, школы, парки — анализ по расстоянию и значимости.", icon: "map", color: "#0ea5e9" },
        ],
      },
      testimonials: {
        title: "Кто попробовал — не возвращается назад.",
        npsLabel: "Средний NPS",
        npsValue: "72",
      ...
      pricing: {
        title1: "Выберите план.",
        title2: "Попробуйте всё",
        titleHighlight: "бесплатно 7 дней",
        subtitle: "Неограниченный экспорт во время пробного периода. Без обязательств. Отмена в любое время.",
        ...
        plans: [
          {
            ...
            savingsYear: null, badge: null, popular: false,
            features: ["5 пользователей включено", "Неограниченные кредиты", "Расчёт цены за м² в реальном времени", "Неограниченные отчёты с вашим логотипом", "AI Rendering & Homestaging", "Шаблоны постов и сторис для соцсетей", "Видеоредактор для соцсетей"],
          ...
          },
          {
            ...
            savingsYear: null, badge: "Хит продаж", popular: false,
            features: ["5 пользователей включено", "Неограниченные кредиты", "Расчёт цены за м² в реальном времени", "Неограниченные отчёты с вашим логотипом", "AI Rendering & Homestaging", "Шаблоны постов и сторис для соцсетей", "Видеоредактор для соцсетей", "Приоритетная поддержка"],
            extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Начать 7 дней бесплатно →",
          },
        ],
      },
      howItWorks: {
        title: "Активно через",
        titleHighlight: "30 секунд",
        subtitle: "Без настройки. Без установки ПО.",
        steps: [
          { step: "1", title: "Выберите план", desc: "Starter, Agency или Pro — то, что вам подходит.", color: "#f59e0b", bg: "#fffbeb", emoji: "target" },
          { step: "2", title: "Установите расширение", desc: "Один клик в Chrome Web Store. 5 секунд.", color: "#6366f1", bg: "#eef2ff", emoji: "puzzle" },
          { step: "3", title: "Просматривайте и анализируйте", desc: "Откройте портал недвижимости — GetNearMe работает.", color: "#10b981", bg: "#ecfdf5", emoji: "sparkles" },
        ],
      },
      faq: {
        title: "Вопросы?",
        ...
        items: [
          { q: "Можно ли попробовать перед оплатой?", a: "Да. 7 дней бесплатного пробного периода с неограниченным экспортом на всех планах. Отмена в один клик, без списаний." },
          { q: "Что происходит после 7 дней?", a: "Активируется ежемесячная подписка. Можно сменить план или отменить в любой момент в профиле." },
          { q: "Скидочные цены навсегда?", a: "Нет. Стартовое предложение временное. Кто подпишется сейчас — сохранит скидочную цену, пока остаётся подписчиком." },
          { q: "Нужно ли устанавливать ПО?", a: "Нет. GetNearMe — это расширение Chrome. Устанавливается за 5 секунд и работает на порталах недвижимости, которые вы уже используете." },
          { q: "Можно ли добавить агентов?", a: "Да. Agency и Pro включают 5 пользователей. Можно добавить ещё от 12€/мес за каждого." },
          { q: "Можно ли использовать свой логотип в PDF?", a: "Да, с планом Pro. Starter и Agency используют бренд GetNearMe." },
        ],
      },
      finalCta: {
        title1: "Ваш следующий договор",
      ...
      modal: {
        ...
        planLabel: "План",
        desc: "Войдите или зарегистрируйтесь, чтобы активировать",
        descBold: "7 дней бесплатного пробного периода",
        descEnd: "с неограниченным экспортом.",
        cta: "Подписаться →",
        footer: "🔒 Без списаний. Отмена в любой момент.",
      },
      popups: [
        { icon: "circle", text: "Лука из Флоренции активировал план Agency", time: "3 мин назад" },
        { icon: "bar-chart", text: "127 отчётов сгенерировано на этой неделе", time: "" },
        { icon: "users", text: "6 агентств онлайн прямо сейчас", time: "" },
        { icon: "home", text: "Марко из Милана сгенерировал 14 отчётов сегодня", time: "5 мин назад" },
        { icon: "star", text: "Агентство Росси перешло на план Pro", time: "18 мин назад" },
        { icon: "trending-up", text: "342 анализа недвижимости завершено сегодня", time: "" },
        { icon: "target", text: "Джулия из Рима экспортировала 8 PDF на этой неделе", time: "7 мин назад" },
        { icon: "briefcase", text: "Агентство из Турина только что зарегистрировалось", time: "2 мин назад" },
        { icon: "trophy", text: "GetNearMe используют более 200 агентств в Италии", time: "" },
        { icon: "smartphone", text: "Андреа из Болоньи создал 5 постов сегодня", time: "9 мин назад" },
        { icon: "rocket", text: "Мария из Неаполя начала бесплатный период", time: "12 мин назад" },
        { icon: "flame", text: "9 агентств выбрали GetNearMe в этом месяце", time: "" },
      ],
    },
  },
  uk: {
    ...
    landing: {
      ...
      problem: {
        emoji: "frown",
        title: "Досі робите аналіз в Excel та скриншотах?",
        desc: "Щодня ви витрачаєте години на збір даних, вставку в документи, пошук актуальних цін. Результат? Презентації, які не виділяють вас.",
      },
      solution: {
        emoji: "rocket",
        title: "GetNearMe автоматизує все в один клік.",
        desc: "Розширення Chrome: аналізує, порівнює, генерує PDF, створює контент для соцмереж та використовує ШІ для підвищення цінності кожного об'єкта. Поки ви переглядаєте — воно працює.",
      },
      features: {
        title: "Кожна функція — це",
        titleHighlight: "конкурентна перевага",
        subtitle: "6 інструментів. Одна мета: допомогти вам закривати більше угод.",
        items: [
          { num: "01", title: "Порівнюйте та закривайте швидше", desc: "Візуальне порівняння об'єктів пліч-о-пліч. Структуровані дані = швидші рішення.", icon: "zap", color: "#f59e0b" },
          { num: "02", title: "ШІ-хоумстейджинг за 10с", desc: "Порожні кімнати → вмебльовані інтер'єри. До/після, що продають ще до перегляду.", icon: "sparkles", color: "#6366f1" },
          { num: "03", title: "Готові пости для соцмереж", desc: "Від оголошення до посту в Instagram/Facebook автоматично. Нуль ручного дизайну.", icon: "smartphone", color: "#ec4899" },
          { num: "04", title: "Відео без відеографа", desc: "Промо-відео для кожного об'єкта за кілька кліків. Контент, що чіпляє.", icon: "clapperboard", color: "#10b981" },
          { num: "05", title: "Ціна за м² в реальному часі", desc: "Конкретні дані для оцінок, придбань та переговорів. Більше ніяких приблизних оцінок.", icon: "bar-chart", color: "#f97316" },
          { num: "06", title: "Розумна карта району", desc: "Сервіси, транспорт, школи, парки — аналіз за відстанню та значущістю.", icon: "map", color: "#0ea5e9" },
        ],
      },
      testimonials: {
        title: "Хто спробував — не повертається назад.",
        npsLabel: "Середній NPS",
        npsValue: "72",
      ...
      pricing: {
        title1: "Оберіть план.",
        title2: "Спробуйте все",
        titleHighlight: "безкоштовно 7 днів",
        subtitle: "Необмежений експорт під час пробного періоду. Без зобов'язань. Скасування в будь-який час.",
        ...
        plans: [
          {
            ...
            savingsYear: null, badge: null, popular: false,
            features: ["5 користувачів включено", "Необмежені кредити", "Розрахунок ціни за м² в реальному часі", "Необмежені звіти з вашим логотипом", "AI Rendering & Homestaging", "Шаблони постів та сторіс для соцмереж", "Відеоредактор для соцмереж"],
          ...
          },
          {
            ...
            savingsYear: null, badge: "Хіт продажів", popular: false,
            features: ["5 користувачів включено", "Необмежені кредити", "Розрахунок ціни за м² в реальному часі", "Необмежені звіти з вашим логотипом", "AI Rendering & Homestaging", "Шаблони постів та сторіс для соцмереж", "Відеоредактор для соцмереж", "Пріоритетна підтримка"],
            extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Почати 7 днів безкоштовно →",
          },
        ],
      },
      howItWorks: {
        title: "Активно через",
        titleHighlight: "30 секунд",
        subtitle: "Без налаштування. Без програмного забезпечення.",
        steps: [
          { step: "1", title: "Оберіть план", desc: "Starter, Agency або Pro — те, що вам підходить.", color: "#f59e0b", bg: "#fffbeb", emoji: "target" },
          { step: "2", title: "Встановіть розширення", desc: "Один клік у Chrome Web Store. 5 секунд.", color: "#6366f1", bg: "#eef2ff", emoji: "puzzle" },
          { step: "3", title: "Переглядайте та аналізуйте", desc: "Відкрийте портал нерухомості — GetNearMe працює.", color: "#10b981", bg: "#ecfdf5", emoji: "sparkles" },
        ],
      },
      faq: {
        title: "Питання?",
        ...
        items: [
          { q: "Чи можна спробувати перед оплатою?", a: "Так. 7 днів безкоштовного пробного періоду з необмеженим експортом на всіх планах. Скасування в один клік, без списань." },
          { q: "Що відбувається після 7 днів?", a: "Активується щомісячна підписка. Можна змінити план або скасувати в будь-який момент у профілі." },
          { q: "Знижкові ціни назавжди?", a: "Ні. Стартова пропозиція тимчасова. Хто підпишеться зараз — збереже знижкову ціну, поки залишається підписником." },
          { q: "Чи потрібно встановлювати ПЗ?", a: "Ні. GetNearMe — це розширення Chrome. Встановлюється за 5 секунд і працює на порталах нерухомості, які ви вже використовуєте." },
          { q: "Чи можна додати агентів?", a: "Так. Agency та Pro включають 5 користувачів. Можна додати ще від 12€/міс за кожного." },
          { q: "Чи можна використовувати свій логотип у PDF?", a: "Так, з планом Pro. Starter та Agency використовують бренд GetNearMe." },
        ],
      },
      finalCta: {
        title1: "Ваш наступний договір",
      ...
      modal: {
        ...
        title: "Чудовий вибір!",
        planLabel: "План",
        desc: "Увійдіть або зареєструйтесь, щоб активувати",
        descBold: "7 днів безкоштовного пробного періоду",
        descEnd: "з необмеженим експортом.",
        cta: "Підписатися →",
        footer: "🔒 Без списань. Скасування в будь-який момент.",
      },
      popups: [
        { icon: "circle", text: "Лука з Флоренції активував план Agency", time: "3 хв тому" },
        { icon: "bar-chart", text: "127 звітів згенеровано цього тижня", time: "" },
        { icon: "users", text: "6 агентств онлайн прямо зараз", time: "" },
        { icon: "home", text: "Марко з Мілана згенерував 14 звітів сьогодні", time: "5 хв тому" },
        { icon: "star", text: "Агентство Россі перейшло на план Pro", time: "18 хв тому" },
        { icon: "trending-up", text: "342 аналізи нерухомості завершено сьогодні", time: "" },
        { icon: "target", text: "Джулія з Рима експортувала 8 PDF цього тижня", time: "7 хв тому" },
        { icon: "briefcase", text: "Агентство з Турина щойно зареєструвалось", time: "2 хв тому" },
        { icon: "trophy", text: "GetNearMe використовують понад 200 агентств в Італії", time: "" },
        { icon: "smartphone", text: "Андреа з Болоньї створив 5 постів сьогодні", time: "9 хв тому" },
        { icon: "rocket", text: "Марія з Неаполя почала безкоштовний період", time: "12 хв тому" },
        { icon: "flame", text: "9 агентств обрали GetNearMe цього місяця", time: "" },
      ],
    },
  }
};
