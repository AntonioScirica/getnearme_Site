...
export const translations = {
  it: {
    ...
    landing: {
      ...
      pricing: {
        title1: "Velocizza e semplifica le attività",
        title2: "per concentrarti sulle",
        titleHighlight: "vendite",
        ...
        plans: [
          {
            ...
            features: ["10 foto AI homestaging", "5 montaggi video", "5 post social", "5 Analisi di zona"],
        ...
        plansByTier: {
          ...
          agency: [
            {
              id: "agency_monthly", name: "Mensile", users: "Per il tuo team", oldPrice: 200, price: 80, period: "/mese a utente", priceNote: "{users} utenti · €{total}/mese",
              savingsYear: null, badge: null, popular: false,
              features: ["{users} collaboratori inclusi (Team)", "Brand condiviso col team", "{photos} foto AI homestaging/mese", "{videos} video AI/mese", "Post social illimitati", "Montaggio Illimitato", "Report Automatici", "Analisi della zona illimitate", "Import immobili", "Supporto prioritario dedicato"],
              extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Scegli questo piano",
            },
            {
              id: "agency_annual", name: "Annuale", users: "Per il tuo team", oldPrice: 150, price: 60, period: "/mese a utente", priceNote: "{users} utenti · €{total}/mese",
              savingsYear: null, badge: "Più scelto", popular: true,
              features: ["{users} collaboratori inclusi (Team)", "Brand condiviso col team", "{photos} foto AI homestaging/mese", "{videos} video AI/mese", "Post social illimitati", "Montaggio Illimitato", "Report Automatici", "Analisi della zona illimitate", "Import immobili", "Supporto prioritario dedicato"],
              extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Scegli questo piano",
            },
            {
              id: "agency_custom", name: "Custom", users: "Per team grandi o esigenze specifiche", oldPrice: null, price: 0, period: "", priceNote: null,
              savingsYear: null, badge: null, popular: false,
              features: ["Più di 10 collaboratori", "Foto e video su misura", "Onboarding assistito", "Contratto e fatturazione dedicati", "Supporto prioritario dedicato"],
              extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Contattaci",
            },
          ],
        },
      },
      ...
      faq: {
        ...
        items: [
          ...
          { q: "L'AI modifica la struttura dell'immobile?", a: "No. Pareti, finestre e spazi restano quelli reali: l'AI cambia solo arredo e illuminazione. Non è una ricostruzione, è una versione arredata della stessa stanza." },
      ...
      sections: {
        heroTitle1: "L'assistente ",
        heroTitleHighlight: "AI per agenti",
        heroTitle2: " immobiliari.",
        flowTitle1: "Dall'annuncio al cliente, ",
        flowTitleHighlight: "in pochi minuti.",
        ...
        flowStep2Chips: ["Home staging", "Video", "Post social"],
        flowStep3Title: "Pubblichi e invii",
        ...
        timeRow2Activity: "Video per l'annuncio",
        timeRow2Before: "mezza giornata col videomaker",
        timeRow2After: "2 minuti",
        timeRow3Activity: "Post per i social",
        timeRow3Before: "~30 minuti su Canva",
        timeRow3After: "1 minuto",
        timeRow4Activity: "Analisi di zona",
        timeRow4Before: "~1 ora tra portali e Google Maps",
        timeRow4After: "10 secondi",
        timeRow5Activity: "Report immobile",
        timeRow5Before: "~45 minuti con Word o PDF",
        timeRow5After: "1 minuto",
        ...
        videoTitles: {
          ...
          closeupDesc: "Video con avatar, script e sottotitoli generati dall'AI.",
          beforeAfter: "Prima vs Dopo",
          beforeAfterDesc: "Partendo da una foto, l'AI arreda e crea il video.",
          dayNight: "Giorno e notte",
          dayNightDesc: "L'AI trasforma l'illuminazione della scena.",
          socialReel: "Reel per i social",
          socialReelDesc: "Reel pronto per Instagram, TikTok e Reels.",
          timelapse: "Timelapse AI",
          timelapseDesc: "Da una foto dell'esterno, l'AI genera il timelapse.",
          splitScreen: "Schermo diviso",
          splitScreenDesc: "Immobile e avatar parlante nello stesso video.",
          imagesToVideo: "Immagini a Video",
          imagesToVideoDesc: "Trasforma le foto dell'immobile in un video animato.",
          subtitles: "Sottotitoli",
          subtitlesDesc: "Video con testo descrittivo animato.",
          montage: "Montaggio",
          montageDesc: "Montaggio automatico multi-stanza con musica.",
        },
        tryWithPhoto: "Prova con la tua foto",
        ...
        refSocialDesc: "Contenuti pronti per Instagram, Facebook, TikTok e LinkedIn.",
        refTryAll: "Provali tutti gratis",
        refComingSoon: "Contenuti in arrivo...",
        refBottomTitle: "Pronto a provare?",
        refBottomSubtitle: "Crei il tuo account in pochi secondi e inizi subito. Gratis, senza carta.",
        refBottomCta: "Prova gratis",
        refBottomDemo: "Prenota una demo",
        socialPostFeed: "Post Feed",
        socialPostFeedDesc: "Formato 4:5 per il feed Instagram e Facebook.",
        socialPostSquare: "Post Quadrato",
        socialPostSquareDesc: "Formato 1:1 per Instagram e LinkedIn.",
        socialPostStory: "Post Story",
        socialPostStoryDesc: "Formato 9:16 per Stories.",
        socialPostReel: "Post Reel",
        socialPostReelDesc: "Formato 9:16 per Reels e TikTok.",
        socialReelFeed: "Reel Feed",
        socialReelFeedDesc: "Animazione automatica in formato feed.",
        socialReelSquare: "Reel Quadrato",
        socialReelSquareDesc: "Animazione automatica in formato quadrato.",
        socialReelStory: "Reel Story",
        socialReelStoryDesc: "Animazione automatica in formato story.",
        socialReelVertical: "Reel Verticale",
        socialReelVerticalDesc: "Animazione automatica in formato reel.",
        featurePriceTitle: "Prezzo medio di zona al m²",
      },
    },
  },
  en: {
    ...
    landing: {
        ...
        plans: [
          {
            ...
            savingsYear: null, badge: null, popular: false,
            features: ["10 AI homestaging photos", "5 social posts & stories"],
          ...
          },
          {
            ...
            features: ["300 AI homestaging photos/month", "6 AI videos/month", "Unlimited social posts & stories", "Automatic Video Editor", "100% Branded Content", "Priority support"],
            extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Choose this plan",
          },
        ],
        plansByTier: {
          ...
          agency: [
            {
              id: "agency_monthly", name: "Monthly", users: "For your team", oldPrice: 200, price: 80, period: "/month per user", priceNote: "{users} users · €{total}/month",
              savingsYear: null, badge: null, popular: false,
              features: ["{users} team members included", "Brand shared across the team", "{photos} AI homestaging photos/month", "{videos} AI videos/month", "Unlimited social posts", "Unlimited editing", "Automatic reports", "Unlimited zone analysis", "Property import", "Dedicated priority support"],
              extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Choose this plan",
            },
            {
              id: "agency_annual", name: "Annual", users: "For your team", oldPrice: 150, price: 60, period: "/month per user", priceNote: "{users} users · €{total}/month",
              savingsYear: null, badge: "Most popular", popular: true,
              features: ["{users} team members included", "Brand shared across the team", "{photos} AI homestaging photos/month", "{videos} AI videos/month", "Unlimited social posts", "Unlimited editing", "Automatic reports", "Unlimited zone analysis", "Property import", "Dedicated priority support"],
              extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Choose this plan",
            },
            {
              id: "agency_custom", name: "Custom", users: "For large teams or specific needs", oldPrice: null, price: 0, period: "", priceNote: null,
              savingsYear: null, badge: null, popular: false,
              features: ["More than 10 team members", "Tailored photo & video volume", "Guided onboarding", "Dedicated contract & billing", "Dedicated priority support"],
              extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Contact us",
            },
          ],
        },
      },
      ...
      faq: {
        ...
        items: [
          ...
          { q: "Does the AI change the property's structure?", a: "No. Walls, windows and layout stay the real ones: the AI only changes furniture and lighting. It is not a reconstruction, it is a furnished version of the same room." },
      ...
      sections: {
        heroTitle1: "The AI assistant ",
        heroTitleHighlight: "for real estate",
        heroTitle2: " agents.",
        flowTitle1: "From listing to client, ",
        flowTitleHighlight: "in minutes.",
        ...
        flowStep2Chips: ["Home staging", "Video", "Social posts"],
        flowStep3Title: "Publish and send",
        ...
        timeRow2Activity: "Video for the listing",
        timeRow2Before: "half a day with a videomaker",
        timeRow2After: "2 minutes",
        timeRow3Activity: "Social media posts",
        timeRow3Before: "~30 minutes on Canva",
        timeRow3After: "1 minute",
        timeRow4Activity: "Area analysis",
        timeRow4Before: "~1 hour across portals and Google Maps",
        timeRow4After: "10 seconds",
        timeRow5Activity: "Property report",
        timeRow5Before: "~45 minutes with Word or PDF",
        timeRow5After: "1 minute",
        ...
        videoTitles: {
          ...
          closeupDesc: "Video with avatar, script and subtitles generated by AI.",
          beforeAfter: "Before vs After",
          beforeAfterDesc: "Starting from a photo, AI furnishes and creates the video.",
          dayNight: "Day and night",
          dayNightDesc: "AI transforms the lighting of the scene.",
          socialReel: "Social reel",
          socialReelDesc: "Reel ready for Instagram, TikTok and Reels.",
          timelapse: "AI Timelapse",
          timelapseDesc: "From an exterior photo, AI generates the timelapse.",
          splitScreen: "Split screen",
          splitScreenDesc: "Property and talking avatar in the same video.",
          imagesToVideo: "Images to Video",
          imagesToVideoDesc: "Transform property photos into an animated video.",
          subtitles: "Subtitles",
          subtitlesDesc: "Video with animated descriptive text.",
          montage: "Montage",
          montageDesc: "Automatic multi-room montage with music.",
        },
        tryWithPhoto: "Try with your photo",
        tryFree: "Try free",
        login: "Sign in",
        ...
        refSocialDesc: "Content ready for Instagram, Facebook, TikTok and LinkedIn.",
        refTryAll: "Try them all for free",
        refComingSoon: "Content coming soon...",
        refBottomTitle: "Ready to try?",
        refBottomSubtitle: "Create your account in seconds and start right away. Free, no card required.",
        refBottomCta: "Try free",
        refBottomDemo: "Book a demo",
        socialPostFeed: "Feed Post",
        socialPostFeedDesc: "4:5 format for Instagram and Facebook feed.",
        socialPostSquare: "Square Post",
        socialPostSquareDesc: "1:1 format for Instagram and LinkedIn.",
        socialPostStory: "Story Post",
        socialPostStoryDesc: "9:16 format for Stories.",
        socialPostReel: "Reel Post",
        socialPostReelDesc: "9:16 format for Reels and TikTok.",
        socialReelFeed: "Feed Reel",
        socialReelFeedDesc: "Automatic animation in feed format.",
        socialReelSquare: "Square Reel",
        socialReelSquareDesc: "Automatic animation in square format.",
        socialReelStory: "Story Reel",
        socialReelStoryDesc: "Automatic animation in story format.",
        socialReelVertical: "Vertical Reel",
        socialReelVerticalDesc: "Automatic animation in reel format.",
        featurePriceTitle: "Average area price per m²",
      },
    },
  },
  es: {
    ...
    landing: {
        ...
        plans: [
          {
            ...
            savingsYear: null, badge: null, popular: false,
            features: ["10 fotos AI homestaging", "5 posts y stories social"],
          ...
          },
          {
            ...
            features: ["300 fotos AI homestaging/mes", "6 videos AI/mes", "Posts y stories social ilimitados", "Editor de Video Automático", "Contenidos 100% Personalizados", "Soporte prioritario"],
            extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Elige este plan",
          },
        ],
        plansByTier: {
          ...
          agency: [
            {
              id: "agency_monthly", name: "Mensual", users: "Para tu equipo", oldPrice: 200, price: 80, period: "/mes por usuario", priceNote: "{users} usuarios · €{total}/mes",
              savingsYear: null, badge: null, popular: false,
              features: ["{users} colaboradores incluidos (Equipo)", "Marca compartida con el equipo", "{photos} fotos AI homestaging/mes", "{videos} videos AI/mes", "Posts sociales ilimitados", "Edicion ilimitada", "Informes automaticos", "Analisis de zona ilimitados", "Importacion de inmuebles", "Soporte prioritario dedicado"],
              extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Elige este plan",
            },
            {
              id: "agency_annual", name: "Anual", users: "Para tu equipo", oldPrice: 150, price: 60, period: "/mes por usuario", priceNote: "{users} usuarios · €{total}/mes",
              savingsYear: null, badge: "Más elegido", popular: true,
              features: ["{users} colaboradores incluidos (Equipo)", "Marca compartida con el equipo", "{photos} fotos AI homestaging/mes", "{videos} videos AI/mes", "Posts sociales ilimitados", "Edicion ilimitada", "Informes automaticos", "Analisis de zona ilimitados", "Importacion de inmuebles", "Soporte prioritario dedicado"],
              extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Elige este plan",
            },
            {
              id: "agency_custom", name: "Custom", users: "Para equipos grandes o necesidades especificas", oldPrice: null, price: 0, period: "", priceNote: null,
              savingsYear: null, badge: null, popular: false,
              features: ["Mas de 10 colaboradores", "Fotos y videos a medida", "Incorporacion asistida", "Contrato y facturacion dedicados", "Soporte prioritario dedicado"],
              extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Contactanos",
            },
          ],
        },
      },
      ...
      faq: {
        ...
        items: [
          ...
          { q: "¿La IA modifica la estructura del inmueble?", a: "No. Paredes, ventanas y espacios siguen siendo los reales: la IA solo cambia el mobiliario y la iluminación. No es una reconstrucción, es una versión amueblada de la misma habitación." },
      ...
      sections: {
        heroTitle1: "El asistente ",
        heroTitleHighlight: "AI para agentes",
        heroTitle2: " inmobiliarios.",
        flowTitle1: "Del anuncio al cliente, ",
        flowTitleHighlight: "en pocos minutos.",
        ...
        flowStep2Chips: ["Home staging", "Vídeo", "Posts sociales"],
        flowStep3Title: "Publicas y envías",
        ...
        timeRow2Activity: "Vídeo para el anuncio",
        timeRow2Before: "medio día con un videomaker",
        timeRow2After: "2 minutos",
        timeRow3Activity: "Posts para redes sociales",
        timeRow3Before: "~30 minutos en Canva",
        timeRow3After: "1 minuto",
        timeRow4Activity: "Análisis de zona",
        timeRow4Before: "~1 hora entre portales y Google Maps",
        timeRow4After: "10 segundos",
        timeRow5Activity: "Informe del inmueble",
        timeRow5Before: "~45 minutos con Word o PDF",
        timeRow5After: "1 minuto",
        ...
        videoTitles: {
          ...
          closeupDesc: "Vídeo con avatar, guion y subtítulos generados por la AI.",
          beforeAfter: "Antes vs Después",
          beforeAfterDesc: "A partir de una foto, la AI amuebla y crea el vídeo.",
          dayNight: "Día y noche",
          dayNightDesc: "La AI transforma la iluminación de la escena.",
          socialReel: "Reel para redes",
          socialReelDesc: "Reel listo para Instagram, TikTok y Reels.",
          timelapse: "Timelapse AI",
          timelapseDesc: "Desde una foto exterior, la AI genera el timelapse.",
          splitScreen: "Pantalla dividida",
          splitScreenDesc: "Inmueble y avatar parlante en el mismo vídeo.",
          imagesToVideo: "Imágenes a Vídeo",
          imagesToVideoDesc: "Transforma las fotos del inmueble en un vídeo animado.",
          subtitles: "Subtítulos",
          subtitlesDesc: "Vídeo con texto descriptivo animado.",
          montage: "Montaje",
          montageDesc: "Montaje automático multi-habitación con música.",
        },
        tryWithPhoto: "Prueba con tu foto",
        ...
        refSocialDesc: "Contenido listo para Instagram, Facebook, TikTok y LinkedIn.",
        refTryAll: "Pruébalos todos gratis",
        refComingSoon: "Contenido próximamente...",
        refBottomTitle: "¿Listo para probar?",
        refBottomSubtitle: "Crea tu cuenta en segundos y empieza enseguida. Gratis, sin tarjeta.",
        refBottomCta: "Prueba gratis",
        refBottomDemo: "Reserva una demo",
        socialPostFeed: "Post Feed",
        socialPostFeedDesc: "Formato 4:5 para el feed de Instagram y Facebook.",
        socialPostSquare: "Post Cuadrado",
        socialPostSquareDesc: "Formato 1:1 para Instagram y LinkedIn.",
        socialPostStory: "Post Story",
        socialPostStoryDesc: "Formato 9:16 para Stories.",
        socialPostReel: "Post Reel",
        socialPostReelDesc: "Formato 9:16 para Reels y TikTok.",
        socialReelFeed: "Reel Feed",
        socialReelFeedDesc: "Animación automática en formato feed.",
        socialReelSquare: "Reel Cuadrado",
        socialReelSquareDesc: "Animación automática en formato cuadrado.",
        socialReelStory: "Reel Story",
        socialReelStoryDesc: "Animación automática en formato story.",
        socialReelVertical: "Reel Vertical",
        socialReelVerticalDesc: "Animación automática en formato reel.",
        featurePriceTitle: "Precio medio de zona por m²",
      },
    },
  },
  fr: {
    ...
    landing: {
        ...
        plans: [
          {
            ...
            savingsYear: null, badge: null, popular: false,
            features: ["10 photos AI homestaging", "5 posts et stories social"],
          ...
          },
          {
            ...
            features: ["300 photos AI homestaging/mois", "6 vidéos AI/mois", "Posts et stories social illimités", "Éditeur Vidéo Automatique", "Contenus 100% Personnalisés", "Support prioritaire"],
            extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Choisir ce plan",
          },
        ],
        plansByTier: {
          ...
          agency: [
            {
              id: "agency_monthly", name: "Mensuel", users: "Pour ton équipe", oldPrice: 200, price: 80, period: "/mois par utilisateur", priceNote: "{users} utilisateurs · {total} €/mois",
              savingsYear: null, badge: null, popular: false,
              features: ["{users} collaborateurs inclus (Équipe)", "Marque partagée avec l'équipe", "{photos} photos AI homestaging/mois", "{videos} vidéos AI/mois", "Posts sociaux illimités", "Montage illimité", "Rapports automatiques", "Analyse de zone illimitée", "Import de biens", "Support prioritaire dédié"],
              extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Choisir ce plan",
            },
            {
              id: "agency_annual", name: "Annuel", users: "Pour ton équipe", oldPrice: 150, price: 60, period: "/mois par utilisateur", priceNote: "{users} utilisateurs · {total} €/mois",
              savingsYear: null, badge: "Le plus choisi", popular: true,
              features: ["{users} collaborateurs inclus (Équipe)", "Marque partagée avec l'équipe", "{photos} photos AI homestaging/mois", "{videos} vidéos AI/mois", "Posts sociaux illimités", "Montage illimité", "Rapports automatiques", "Analyse de zone illimitée", "Import de biens", "Support prioritaire dédié"],
              extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Choisir ce plan",
            },
            {
              id: "agency_custom", name: "Custom", users: "Pour grandes équipes ou besoins spécifiques", oldPrice: null, price: 0, period: "", priceNote: null,
              savingsYear: null, badge: null, popular: false,
              features: ["Plus de 10 collaborateurs", "Photos et vidéos sur mesure", "Onboarding accompagné", "Contrat et facturation dédiés", "Support prioritaire dédié"],
              extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Contactez-nous",
            },
          ],
        },
      },
      ...
      faq: {
        ...
        items: [
          ...
          { q: "L'IA modifie-t-elle la structure du bien ?", a: "Non. Murs, fenêtres et espaces restent les vrais : l'IA change seulement le mobilier et l'éclairage. Ce n'est pas une reconstruction, c'est une version meublée de la même pièce." },
    ...
    landing: {
        ...
        plans: [
          {
            ...
            savingsYear: null, badge: null, popular: false,
            features: ["10 фото AI homestaging", "5 постов и сторис"],
          ...
          },
          {
            ...
            features: ["300 фото AI homestaging/месяц", "6 AI видео/месяц", "Безлимитные посты и сторис", "Автоматический Видеоредактор", "100% Брендированный Контент", "Приоритетная поддержка"],
            extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Выбрать этот план",
          },
        ],
        plansByTier: {
          ...
          agency: [
            {
              id: "agency_monthly", name: "Месячный", users: "Для вашей команды", oldPrice: 200, price: 80, period: "/мес на пользователя", priceNote: "{users} пользователей · €{total}/мес",
              savingsYear: null, badge: null, popular: false,
              features: ["{users} сотрудников в команде", "Общий бренд для команды", "{photos} фото AI homestaging/месяц", "{videos} AI видео/месяц", "Безлимитные соцсети", "Безлимитный монтаж", "Автоматические отчёты", "Безлимитный анализ зоны", "Импорт недвижимости", "Выделенная приоритетная поддержка"],
              extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Выбрать этот план",
            },
            {
              id: "agency_annual", name: "Годовой", users: "Для вашей команды", oldPrice: 150, price: 60, period: "/мес на пользователя", priceNote: "{users} пользователей · €{total}/мес",
              savingsYear: null, badge: "Самый популярный", popular: true,
              features: ["{users} сотрудников в команде", "Общий бренд для команды", "{photos} фото AI homestaging/месяц", "{videos} AI видео/месяц", "Безлимитные соцсети", "Безлимитный монтаж", "Автоматические отчёты", "Безлимитный анализ зоны", "Импорт недвижимости", "Выделенная приоритетная поддержка"],
              extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Выбрать этот план",
            },
            {
              id: "agency_custom", name: "Custom", users: "Для больших команд или особых задач", oldPrice: null, price: 0, period: "", priceNote: null,
              savingsYear: null, badge: null, popular: false,
              features: ["Более 10 сотрудников", "Индивидуальный объём фото и видео", "Сопровождение при подключении", "Отдельный договор и биллинг", "Выделенная приоритетная поддержка"],
              extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Связаться с нами",
            },
          ],
        },
      },
      ...
      faq: {
        ...
        items: [
          ...
          { q: "ИИ меняет структуру объекта?", a: "Нет. Стены, окна и планировка остаются настоящими: ИИ меняет только мебель и освещение. Это не реконструкция, а меблированная версия той же комнаты." },
    ...
    landing: {
        ...
        plans: [
          {
            ...
            savingsYear: null, badge: null, popular: false,
            features: ["10 фото AI homestaging", "5 постів і сторіс"],
          ...
          },
          {
            ...
            features: ["300 фото AI homestaging/місяць", "4 AI відео/місяць", "Безлімітні пости і сторіс", "Автоматичний Відеоредактор", "100% Брендований Контент", "Пріоритетна підтримка"],
            extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Обрати цей план",
          },
        ],
        plansByTier: {
          ...
          agency: [
            {
              id: "agency_monthly", name: "Місячний", users: "Для вашої команди", oldPrice: 200, price: 80, period: "/міс на користувача", priceNote: "{users} користувачів · €{total}/міс",
              savingsYear: null, badge: null, popular: false,
              features: ["{users} співробітників у команді", "Спільний бренд для команди", "{photos} фото AI homestaging/місяць", "{videos} AI відео/місяць", "Безлімітні соцмережі", "Безлімітний монтаж", "Автоматичні звіти", "Безлімітний аналіз зони", "Імпорт нерухомості", "Виділена пріоритетна підтримка"],
              extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Обрати цей план",
            },
            {
              id: "agency_annual", name: "Річний", users: "Для вашої команди", oldPrice: 150, price: 60, period: "/міс на користувача", priceNote: "{users} користувачів · €{total}/міс",
              savingsYear: null, badge: "Найпопулярніший", popular: true,
              features: ["{users} співробітників у команді", "Спільний бренд для команди", "{photos} фото AI homestaging/місяць", "{videos} AI відео/місяць", "Безлімітні соцмережі", "Безлімітний монтаж", "Автоматичні звіти", "Безлімітний аналіз зони", "Імпорт нерухомості", "Виділена пріоритетна підтримка"],
              extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Обрати цей план",
            },
            {
              id: "agency_custom", name: "Custom", users: "Для великих команд або особливих потреб", oldPrice: null, price: 0, period: "", priceNote: null,
              savingsYear: null, badge: null, popular: false,
              features: ["Понад 10 співробітників", "Індивідуальний обсяг фото і відео", "Супровід при підключенні", "Окремий договір і білінг", "Виділена пріоритетна підтримка"],
              extra: null, color: "#2563EB", bg: "#eff6ff", cta: "Зв'язатися з нами",
            },
          ],
        },
      },
      ...
      faq: {
        ...
        items: [
          ...
          { q: "AI змінює структуру об'єкта?", a: "Ні. Стіни, вікна і планування залишаються справжніми: AI змінює лише меблі і освітлення. Це не реконструкція, а мебльована версія тієї ж кімнати." },
