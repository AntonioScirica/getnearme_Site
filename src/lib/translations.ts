        ...
        plans: [
          {
            ...
            savingsYear: 432, badge: null, popular: false,
            features: ["Calcolo prezzo al m² in tempo reale", "Export PDF illimitati (brand GetNearMe)"],
            extra: null, color: "#10b981", bg: "#ecfdf5", cta: "Inizia 7 giorni gratis →",
          },
          {
            id: "agency", name: "Agency", users: "5 utenti inclusi", oldPrice: 150, price: 99,
            savingsYear: 612, badge: "Più popolare", popular: true,
            features: ["Tutto di Starter, più:", "Template Post & Stories Social", "AI Rendering & Homestaging"],
        ...
        plans: [
          {
            ...
            savingsYear: 432, badge: null, popular: false,
            features: ["Real-time price per m² calculation", "Unlimited PDF exports (GetNearMe brand)"],
            extra: null, color: "#10b981", bg: "#ecfdf5", cta: "Start 7-day free trial →",
          },
          {
            id: "agency", name: "Agency", users: "5 users included", oldPrice: 150, price: 99,
            savingsYear: 612, badge: "Most popular", popular: true,
            features: ["Everything in Starter, plus:", "Social Post & Stories Templates", "AI Rendering & Homestaging"],
        ...
        plans: [
          {
            ...
            savingsYear: 432, badge: null, popular: false,
            features: ["Cálculo de precio por m² en tiempo real", "Exportación PDF ilimitada (marca GetNearMe)"],
            extra: null, color: "#10b981", bg: "#ecfdf5", cta: "Empieza 7 días gratis →",
          },
          {
            id: "agency", name: "Agency", users: "5 usuarios incluidos", oldPrice: 150, price: 99,
            savingsYear: 612, badge: "Más popular", popular: true,
            features: ["Todo de Starter, más:", "Plantillas Post & Stories Social", "AI Rendering & Homestaging"],
        ...
        plans: [
          {
            ...
            savingsYear: 432, badge: null, popular: false,
            features: ["Calcul du prix au m² en temps réel", "Export PDF illimités (marque GetNearMe)"],
            extra: null, color: "#10b981", bg: "#ecfdf5", cta: "Commencer 7 jours gratuits →",
          },
          {
            id: "agency", name: "Agency", users: "5 utilisateurs inclus", oldPrice: 150, price: 99,
            savingsYear: 612, badge: "Le plus populaire", popular: true,
            features: ["Tout de Starter, plus :", "Templates Post & Stories Social", "AI Rendering & Homestaging"],
        ...
        plans: [
          {
            ...
            savingsYear: 432, badge: null, popular: false,
            features: ["Расчёт цены за м² в реальном времени", "Неограниченный экспорт PDF (бренд GetNearMe)"],
            extra: null, color: "#10b981", bg: "#ecfdf5", cta: "Начать 7 дней бесплатно →",
          },
          {
            id: "agency", name: "Agency", users: "5 пользователей включено", oldPrice: 150, price: 99,
            savingsYear: 612, badge: "Самый популярный", popular: true,
            features: ["Всё из Starter, плюс:", "Шаблоны постов и сторис для соцсетей", "AI Rendering & Homestaging"],
        ...
        plans: [
          {
            ...
            savingsYear: 432, badge: null, popular: false,
            features: ["Розрахунок ціни за м² в реальному часі", "Необмежений експорт PDF (бренд GetNearMe)"],
            extra: null, color: "#10b981", bg: "#ecfdf5", cta: "Почати 7 днів безкоштовно →",
          },
          {
            id: "agency", name: "Agency", users: "5 користувачів включено", oldPrice: 150, price: 99,
            savingsYear: 612, badge: "Найпопулярніший", popular: true,
            features: ["Все зі Starter, плюс:", "Шаблони постів та сторіс для соцмереж", "AI Rendering & Homestaging"],
